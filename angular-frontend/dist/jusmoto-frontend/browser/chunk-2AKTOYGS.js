...
var CreateTicketComponent = class _CreateTicketComponent {
  ...
  }, dependencies: [CommonModule, RouterModule, RouterLink, FormsModule, \u0275NgNoValidate, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, SelectControlValueAccessor, NgControlStatus, NgControlStatusGroup, ReactiveFormsModule, FormGroupDirective, FormControlName], styles: [`
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CreateTicketComponent, { className: "CreateTicketComponent", filePath: "src\\app\\features\\tickets\\create-ticket\\create-ticket.component.ts", lineNumber: 72 });
})();
export {
