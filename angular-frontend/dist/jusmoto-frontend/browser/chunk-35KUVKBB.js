...
var ClientChallanDetailComponent = class _ClientChallanDetailComponent {
  ...
  challan = signal(null);
  loading = signal(true);
  constructor(route, router, challanService, toast) {
    this.route = route;
    this.router = router;
  ...
  static \u0275fac = function ClientChallanDetailComponent_Factory(t) {
    return new (t || _ClientChallanDetailComponent)(\u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ChallanService), \u0275\u0275directiveInject(ToastService));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClientChallanDetailComponent, { className: "ClientChallanDetailComponent", filePath: "src\\app\\features\\client\\traffic-challan\\challan-detail.component.ts", lineNumber: 388 });
})();
export {
