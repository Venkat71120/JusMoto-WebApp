...
var MediaPickerComponent = class _MediaPickerComponent {
  ...
  loadPreview() {
    ...
    if (typeof this.value === "number" || /^\d+$/.test(String(this.value))) {
      this.http.get(`${this.apiUrl}/admin/media?limit=1&search=`).subscribe({
        next: (res) => {
