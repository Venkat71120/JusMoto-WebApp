...
var AddressListComponent = class _AddressListComponent {
  ...
  static \u0275fac = function AddressListComponent_Factory(t) {
    return new (t || _AddressListComponent)(\u0275\u0275directiveInject(HttpClient), \u0275\u0275directiveInject(ToastService));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddressListComponent, { className: "AddressListComponent", filePath: "src\\app\\features\\client\\address\\address-list.component.ts", lineNumber: 248 });
})();
export {
