...
var FavouritesComponent = class _FavouritesComponent {
  ...
  favourites = signal([]);
  loading = signal(true);
  constructor(serviceService, cartService, toast) {
  ...
  static \u0275fac = function FavouritesComponent_Factory(t) {
    return new (t || _FavouritesComponent)(\u0275\u0275directiveInject(ServiceService), \u0275\u0275directiveInject(CartService), \u0275\u0275directiveInject(ToastService));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FavouritesComponent, { className: "FavouritesComponent", filePath: "src\\app\\features\\client\\favourites\\favourites.component.ts", lineNumber: 260 });
})();
export {
  FavouritesComponent
};
