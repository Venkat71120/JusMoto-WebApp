...
function CarListComponent_tr_35_img_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("src", ctx_r3.getImageUrl(car_r3.image), \u0275\u0275sanitizeUrl);
  }
}
...
function CarListComponent_div_38_div_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("src", ctx_r3.getImageUrl((tmp_2_0 = ctx_r3.viewCar()) == null ? null : tmp_2_0.image), \u0275\u0275sanitizeUrl);
  }
}
