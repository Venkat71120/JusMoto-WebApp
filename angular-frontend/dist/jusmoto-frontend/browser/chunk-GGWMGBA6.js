...
var ClientChallanCheckComponent = class _ClientChallanCheckComponent {
  ...
  results = signal([]);
  error = signal("");
  constructor(fb, challanService, router, toast) {
    this.fb = fb;
  ...
  static \u0275fac = function ClientChallanCheckComponent_Factory(t) {
    return new (t || _ClientChallanCheckComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(ChallanService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ToastService));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClientChallanCheckComponent, { className: "ClientChallanCheckComponent", filePath: "src\\app\\features\\client\\traffic-challan\\challan-check.component.ts", lineNumber: 363 });
})();
export {
