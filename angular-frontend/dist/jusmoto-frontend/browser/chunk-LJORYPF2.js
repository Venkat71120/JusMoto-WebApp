...
function AddressesComponent_Conditional_6_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, AddressesComponent_Conditional_6_For_2_Conditional_1_Template, 2, 0, "span", 9);
    \u0275\u0275elementStart(2, "h3", 10);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(12, "Edit");
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, AddressesComponent_Conditional_6_For_2_Conditional_13_Template, 2, 0, "button", 16);
...
function AddressesComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, AddressesComponent_Conditional_6_For_2_Template, 16, 12, "div", 7, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AddressesComponent_Conditional_8_span_33_Template(rf, ctx) {
  if (rf & 1) {
...
function AddressesComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 6)(1, "div", 22)(2, "h2", 23);
    \u0275\u0275text(3, "Add New Address");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 24)(5, "div")(6, "label", 25);
    \u0275\u0275text(7, "Label");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "select", 26);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "div", 31)(20, "div")(21, "label", 25);
    \u0275\u0275text(22, "City");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "input", 32);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "div")(25, "label", 25);
    \u0275\u0275text(26, "Pincode");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(28, "div")(29, "label", 25);
    \u0275\u0275text(30, "Phone");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "input", 33, 0);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(33, AddressesComponent_Conditional_8_span_33_Template, 2, 0, "span", 34);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "label", 35)(35, "input", 36);
    \u0275\u0275twoWayListener("ngModelChange", function AddressesComponent_Conditional_8_Template_input_ngModelChange_35_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(37, "Set as default address");
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275listener("click", function AddressesComponent_Conditional_8_Template_button_click_41_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.addAddress());
    });
    \u0275\u0275text(42, "Add Address");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const addrPhone_r7 = \u0275\u0275reference(32);
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(8);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", addrPhone_r7.touched && addrPhone_r7.invalid);
    \u0275\u0275advance(2);
...
var AddressesComponent = class _AddressesComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddressesComponent, selectors: [["app-addresses"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 9, vars: 2, consts: [["addrPhone", "ngModel"], [1, "container", "mx-auto", "px-4", "py-8"], [1, "flex", "justify-between", "items-center", "mb-6"], [1, "text-3xl", "font-bold"], [1, "bg-blue-600", "text-white", "px-4", "py-2", "rounded", "hover:bg-blue-700", 3, "click"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "gap-6"], [1, "fixed", "inset-0", "bg-black", "bg-opacity-50", "flex", "items-center", "justify-center", "z-50"], [1, "bg-white", "rounded-lg", "shadow", "p-6", 3, "border-2", "border-blue-500"], [1, "bg-white", "rounded-lg", "shadow", "p-6"], [1, "inline-block", "bg-blue-100", "text-blue-800", "text-xs", "px-2", "py-1", "rounded", "mb-2"], [1, "font-bold", "text-lg"], [1, "text-gray-600", "mt-2"], [1, "text-gray-600"], [1, "text-gray-500", "mt-2"], [1, "flex", "gap-2", "mt-4"], [1, "flex-1", "bg-gray-100", "text-gray-700", "py-2", "rounded", "hover:bg-gray-200"], [1, "flex-1", "bg-blue-100", "text-blue-700", "py-2", "rounded", "hover:bg-blue-200"], [1, "flex-1", "bg-red-100", "text-red-700", "py-2", "rounded", "hover:bg-red-200", 3, "click"], [1, "flex-1", "bg-blue-100", "text-blue-700", "py-2", "rounded", "hover:bg-blue-200", 3, "click"], [1, "text-center", "py-12", "bg-white", "rounded-lg", "shadow"], [1, "text-xl", "text-gray-500", "mb-4"], [1, "bg-blue-600", "text-white", "px-6", "py-2", "rounded", "hover:bg-blue-700", 3, "click"], [1, "bg-white", "rounded-lg", "p-6", "w-full", "max-w-md"], [1, "text-xl", "font-bold", "mb-4"], [1, "space-y-4"], [1, "block", "text-sm", "font-medium", "mb-1"], [1, "w-full", "p-2", "border", "rounded", 3, "ngModelChange", "ngModel"], ["value", "Home"], ["value", "Office"], ["value", "Other"], ["rows", "3", 1, "w-full", "p-2", "border", "rounded", 3, "ngModelChange", "ngModel"], [1, "grid", "grid-cols-2", "gap-4"], ["type", "text", 1, "w-full", "p-2", "border", "rounded", 3, "ngModelChange", "ngModel"], ["type", "tel", "maxlength", "10", "placeholder", "10-digit phone number", "pattern", "\\d{10}", 1, "w-full", "p-2", "border", "rounded", 3, "ngModelChange", "ngModel"], ["class", "text-red-500 text-xs mt-1 block", 4, "ngIf"], [1, "flex", "items-center", "gap-2"], ["type", "checkbox", 3, "ngModelChange", "ngModel"], [1, "flex", "gap-4", "mt-6"], [1, "flex-1", "bg-gray-200", "py-2", "rounded", "hover:bg-gray-300", 3, "click"], [1, "flex-1", "bg-blue-600", "text-white", "py-2", "rounded", "hover:bg-blue-700", 3, "click"], [1, "text-red-500", "text-xs", "mt-1", "block"]], template: function AddressesComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275template(6, AddressesComponent_Conditional_6_Template, 3, 0, "div", 5)(7, AddressesComponent_Conditional_7_Template, 5, 0)(8, AddressesComponent_Conditional_8_Template, 43, 7, "div", 6);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(6);
  ...
  }, dependencies: [CommonModule, NgIf, FormsModule, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, CheckboxControlValueAccessor, SelectControlValueAccessor, NgControlStatus, MaxLengthValidator, PatternValidator, NgModel], styles: [`
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddressesComponent, { className: "AddressesComponent", filePath: "src\\app\\features\\profile\\addresses\\addresses.component.ts", lineNumber: 99 });
})();
export {
  AddressesComponent
};
