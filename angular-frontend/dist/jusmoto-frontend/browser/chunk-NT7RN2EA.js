...
var adminRoutes = [
  {
    ...
    children: [
      ...
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-TPMULT4K.js").then((m) => m.AdminDashboardComponent)
      },
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      // Users
      { path: "user/all-users", loadComponent: () => import("./chunk-ZPAWD65G.js").then((m) => m.UserListComponent) },
      { path: "user/details/:id", loadComponent: () => import("./chunk-HSDAHDLH.js").then((m) => m.UserDetailComponent) },
      // Orders
      { path: "orders/all-orders", loadComponent: () => import("./chunk-XKGCX7DX.js").then((m) => m.OrderListComponent) },
      { path: "orders/details/:id", loadComponent: () => import("./chunk-UPW6UD7R.js").then((m) => m.OrderDetailComponent) },
      { path: "orders/refunded-order-list", loadComponent: () => import("./chunk-OPLB7LAE.js").then((m) => m.RefundListComponent) },
      // Services
      { path: "services/all", loadComponent: () => import("./chunk-R3QZZKKC.js").then((m) => m.ServiceListComponent) },
      { path: "services/add", loadComponent: () => import("./chunk-ZSRCKNGH.js").then((m) => m.ServiceFormComponent) },
      { path: "services/edit-service/:id", loadComponent: () => import("./chunk-ZSRCKNGH.js").then((m) => m.ServiceFormComponent) },
      // Categories
      { path: "category/index", loadComponent: () => import("./chunk-Q4CICCLX.js").then((m) => m.CategoryListComponent) },
      { path: "category/add-new-category", loadComponent: () => import("./chunk-RR7U7JZA.js").then((m) => m.CategoryFormComponent) },
      { path: "category/edit-category/:id", loadComponent: () => import("./chunk-RR7U7JZA.js").then((m) => m.CategoryFormComponent) },
      // Sub-Categories
      { path: "subcategory/index", loadComponent: () => import("./chunk-K2J2FMFR.js").then((m) => m.SubCategoryListComponent) },
      { path: "subcategory/add-new-subcategory", loadComponent: () => import("./chunk-Z4H2GPF5.js").then((m) => m.SubCategoryFormComponent) },
      { path: "subcategory/edit-subcategory/:id", loadComponent: () => import("./chunk-Z4H2GPF5.js").then((m) => m.SubCategoryFormComponent) },
      // Brands
      { path: "brand/list", loadComponent: () => import("./chunk-M7JKZKOM.js").then((m) => m.BrandListComponent) },
      // Cars
      { path: "car/list", loadComponent: () => import("./chunk-P5F55TCJ.js").then((m) => m.CarListComponent) },
      { path: "car/add", loadComponent: () => import("./chunk-TU2GNMTG.js").then((m) => m.CarFormComponent) },
      { path: "car/edit-car/:id", loadComponent: () => import("./chunk-TU2GNMTG.js").then((m) => m.CarFormComponent) },
      // Variants
      { path: "variant/list", loadComponent: () => import("./chunk-R6GO5W6O.js").then((m) => m.VariantListComponent) },
      { path: "variant/add", loadComponent: () => import("./chunk-UYCCQOC2.js").then((m) => m.VariantFormComponent) },
      { path: "variant/edit/:id", loadComponent: () => import("./chunk-UYCCQOC2.js").then((m) => m.VariantFormComponent) },
      // Engine Types
      { path: "engine/list", loadComponent: () => import("./chunk-PDSYDK3J.js").then((m) => m.EngineTypeListComponent) },
      // Fuel Types
      { path: "fual/list", loadComponent: () => import("./chunk-QWAFYY3G.js").then((m) => m.FuelTypeListComponent) },
      // Coupons
      { path: "coupons/all", loadComponent: () => import("./chunk-6ZHMBTOD.js").then((m) => m.CouponListComponent) },
      { path: "coupons/new", loadComponent: () => import("./chunk-OYH264GG.js").then((m) => m.CouponFormComponent) },
      { path: "coupons/edit/:id", loadComponent: () => import("./chunk-OYH264GG.js").then((m) => m.CouponFormComponent) },
      // Offers
      { path: "offer/list", loadComponent: () => import("./chunk-B6QZOYA6.js").then((m) => m.OfferListComponent) },
      { path: "offer/add", loadComponent: () => import("./chunk-QMAQ663Q.js").then((m) => m.OfferFormComponent) },
      { path: "offer/edit-offer/:id", loadComponent: () => import("./chunk-QMAQ663Q.js").then((m) => m.OfferFormComponent) },
      // Sliders
      { path: "slider/all", loadComponent: () => import("./chunk-B73O5EEI.js").then((m) => m.SliderListComponent) },
      { path: "slider/add", loadComponent: () => import("./chunk-WSGYTBQE.js").then((m) => m.SliderFormComponent) },
      { path: "slider/edit/:id", loadComponent: () => import("./chunk-WSGYTBQE.js").then((m) => m.SliderFormComponent) },
      // Support Tickets
      { path: "support-ticket/tickets", loadComponent: () => import("./chunk-6BOZQX5A.js").then((m) => m.TicketListComponent) },
      { path: "support-ticket/details/:id", loadComponent: () => import("./chunk-Z6EYZEDC.js").then((m) => m.TicketDetailComponent) },
      { path: "support-ticket/department", loadComponent: () => import("./chunk-QN6D2VFP.js").then((m) => m.DepartmentListComponent) },
      // Staff / Admins
      { path: "staff/all-staff", loadComponent: () => import("./chunk-UP6XMINT.js").then((m) => m.StaffListComponent) },
      { path: "staff/add-staff", loadComponent: () => import("./chunk-Y6LPT5M2.js").then((m) => m.StaffFormComponent) },
      { path: "staff/edit-user-info/:id", loadComponent: () => import("./chunk-Y6LPT5M2.js").then((m) => m.StaffFormComponent) },
      // Roles & Permissions
      { path: "manage/permission/role/all", loadComponent: () => import("./chunk-TRK56R2V.js").then((m) => m.RoleListComponent) },
      { path: "manage/permission/role/add", loadComponent: () => import("./chunk-NGALENR6.js").then((m) => m.RoleFormComponent) },
      { path: "manage/permission/role/edit/:id", loadComponent: () => import("./chunk-NGALENR6.js").then((m) => m.RoleFormComponent) },
      // Franchises
      { path: "franchise/list", loadComponent: () => import("./chunk-PDMHYOBN.js").then((m) => m.FranchiseListComponent) },
      { path: "franchise/add", loadComponent: () => import("./chunk-7RFHNE36.js").then((m) => m.FranchiseFormComponent) },
      // Reports
      { path: "reports/revenue", loadComponent: () => import("./chunk-Q6PR5F32.js").then((m) => m.RevenueReportComponent) },
      { path: "reports/orders", loadComponent: () => import("./chunk-QRGLJMN3.js").then((m) => m.OrderReportComponent) },
      // Wallet Management
      { path: "wallet/manage", loadComponent: () => import("./chunk-IU2QVZYO.js").then((m) => m.WalletManagementComponent) },
      // Settings
      { path: "settings/general", loadComponent: () => import("./chunk-J2QRJVMU.js").then((m) => m.GeneralSettingsComponent) },
      // Locations
      { path: "location/state/all-state", loadComponent: () => import("./chunk-QEUCGPVJ.js").then((m) => m.StateListComponent) },
      { path: "location/city/all-city", loadComponent: () => import("./chunk-XGMEJ56I.js").then((m) => m.CityListComponent) },
      { path: "location/area/all-area", loadComponent: () => import("./chunk-DXWBGLOR.js").then((m) => m.AreaListComponent) },
      // Outlet Locations
      { path: "outletAddress/all", loadComponent: () => import("./chunk-ELSE43L2.js").then((m) => m.OutletLocationListComponent) },
      { path: "outletAddress/add", loadComponent: () => import("./chunk-AIILG5KT.js").then((m) => m.OutletLocationFormComponent) },
      { path: "outletAddress/edit-outlet/:id", loadComponent: () => import("./chunk-AIILG5KT.js").then((m) => m.OutletLocationFormComponent) },
      // Reviews
      { path: "review/all", loadComponent: () => import("./chunk-DXGX5PCO.js").then((m) => m.ReviewListComponent) },
      // Notifications
      { path: "notification/all", loadComponent: () => import("./chunk-FAYYFVSH.js").then((m) => m.NotificationListComponent) },
      // Media Library
      { path: "media/all", loadComponent: () => import("./chunk-LQJ2LCMT.js").then((m) => m.MediaLibraryComponent) }
    ]
  }
];
export {
