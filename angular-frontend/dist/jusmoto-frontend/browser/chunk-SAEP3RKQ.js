...
function MediaPickerComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 4)(1, "img", 5);
...
function MediaPickerComponent_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "rect", 12)(3, "circle", 13)(4, "polyline", 14);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
...
function MediaPickerComponent_div_3_div_12_div_11_Template(rf, ctx) {
  if (rf & 1) {
...
function MediaPickerComponent_div_3_div_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 24)(1, "label", 25)(2, "input", 26);
    ...
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(7, "p");
    \u0275\u0275text(8, "Click or drag image to upload");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "span", 31);
    \u0275\u0275text(10, "Max 10MB, JPEG/PNG/WebP");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(11, MediaPickerComponent_div_3_div_12_div_11_Template, 4, 0, "div", 32);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MediaPickerComponent_div_3_div_13_div_3_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MediaPickerComponent_div_3_div_13_div_3_div_1_Template_div_click_0_listener() {
      ...
      return \u0275\u0275resetView(ctx_r1.selectFromLibrary(item_r7));
    });
    \u0275\u0275element(1, "img", 45);
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275classProp("selected", ((tmp_5_0 = ctx_r1.selectedLibItem()) == null ? null : tmp_5_0.id) === item_r7.id);
    \u0275\u0275advance();
    \u0275\u0275property("src", ctx_r1.getThumbUrl(item_r7), \u0275\u0275sanitizeUrl)("alt", item_r7.title);
    \u0275\u0275advance(2);
...
function MediaPickerComponent_div_3_div_13_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, MediaPickerComponent_div_3_div_13_div_3_div_1_Template, 4, 5, "div", 43);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function MediaPickerComponent_div_3_div_13_div_5_button_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275classProp("active", p_r9 === ctx_r1.libPage());
    \u0275\u0275advance();
...
function MediaPickerComponent_div_3_div_13_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, MediaPickerComponent_div_3_div_13_div_5_button_1_Template, 2, 3, "button", 49);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function MediaPickerComponent_div_3_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 35)(1, "input", 36);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(2, MediaPickerComponent_div_3_div_13_div_2_Template, 2, 0, "div", 37)(3, MediaPickerComponent_div_3_div_13_div_3_Template, 2, 1, "div", 38)(4, MediaPickerComponent_div_3_div_13_div_4_Template, 3, 0, "div", 39)(5, MediaPickerComponent_div_3_div_13_div_5_Template, 2, 1, "div", 40);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MediaPickerComponent_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(12, MediaPickerComponent_div_3_div_12_Template, 12, 3, "div", 21)(13, MediaPickerComponent_div_3_div_13_Template, 6, 5, "div", 22)(14, MediaPickerComponent_div_3_div_14_Template, 5, 1, "div", 23);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var MediaPickerComponent = class _MediaPickerComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MediaPickerComponent, selectors: [["app-media-picker"]], inputs: { value: "value", label: "label" }, outputs: { valueChange: "valueChange", mediaSelected: "mediaSelected" }, standalone: true, features: [\u0275\u0275NgOnChangesFeature, \u0275\u0275StandaloneFeature], decls: 4, vars: 3, consts: [[1, "picker-trigger", 3, "click"], ["class", "preview", 4, "ngIf"], ["class", "placeholder", 4, "ngIf"], ["class", "modal-overlay", 3, "click", 4, "ngIf"], [1, "preview"], ["alt", "Selected image", 3, "error", "src"], ["title", "Remove", 1, "remove-btn", 3, "click"], ["width", "14", "height", "14", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"], [1, "placeholder"], ["width", "32", "height", "32", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1.5"], ["x", "3", "y", "3", "width", "18", "height", "18", "rx", "2"], ["cx", "8.5", "cy", "8.5", "r", "1.5"], ["points", "21 15 16 10 5 21"], [1, "modal-overlay", 3, "click"], [1, "modal", 3, "click"], [1, "modal-header"], [1, "modal-close", 3, "click"], [1, "modal-tabs"], ["type", "button", 3, "click"], ["class", "upload-tab", 4, "ngIf"], ["class", "library-tab", 4, "ngIf"], ["class", "modal-footer", 4, "ngIf"], [1, "upload-tab"], [1, "drop-zone"], ["type", "file", "accept", "image/*", 2, "display", "none", 3, "change"], ["width", "48", "height", "48", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1.5"], ["d", "M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"], ["points", "17 8 12 3 7 8"], ["x1", "12", "y1", "3", "x2", "12", "y2", "15"], [1, "hint"], ["class", "upload-progress", 4, "ngIf"], [1, "upload-progress"], [1, "spinner-small"], [1, "library-tab"], ["type", "text", "placeholder", "Search images...", 1, "lib-search", 3, "ngModelChange", "input", "ngModel"], ["class", "lib-loading", 4, "ngIf"], ["class", "lib-grid", 4, "ngIf"], ["class", "lib-empty", 4, "ngIf"], ["class", "lib-pagination", 4, "ngIf"], [1, "lib-loading"], [1, "lib-grid"], ["class", "lib-item", 3, "selected", "click", 4, "ngFor", "ngForOf"], [1, "lib-item", 3, "click"], ["loading", "lazy", 3, "src", "alt"], [1, "lib-item-name"], [1, "lib-empty"], [1, "lib-pagination"], [3, "active", "click", 4, "ngFor", "ngForOf"], [3, "click"], [1, "modal-footer"], [1, "btn-cancel", 3, "click"], [1, "btn-select", 3, "click", "disabled"]], template: function MediaPickerComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275listener("click", function MediaPickerComponent_Template_div_click_0_listener() {
        return ctx.openModal();
      });
      \u0275\u0275template(1, MediaPickerComponent_div_1_Template, 6, 1, "div", 1)(2, MediaPickerComponent_div_2_Template, 7, 1, "div", 2);
      \u0275\u0275elementEnd();
      \u0275\u0275template(3, MediaPickerComponent_div_3_Template, 15, 7, "div", 3);
    }
    if (rf & 2) {
      \u0275\u0275advance();
