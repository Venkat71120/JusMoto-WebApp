...
var _c0 = (a0) => ["/admin/products/view", a0];
var _c1 = (a0) => ["/admin/services/view", a0];
var _c2 = (a0) => ["/admin/products/edit", a0];
var _c3 = (a0) => ["/admin/services/edit-service", a0];
...
function ServiceListComponent_tr_48_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(28, "path", 32)(29, "circle", 33);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(30, "a", 34);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(31, "svg", 31);
    \u0275\u0275element(32, "path", 35)(33, "path", 36);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(34, "button", 37);
    \u0275\u0275listener("click", function ServiceListComponent_tr_48_Template_button_click_34_listener() {
      const svc_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.deleteService(svc_r2));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(35, "svg", 31);
    \u0275\u0275element(36, "polyline", 38)(37, "path", 39);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("\u20B9", \u0275\u0275pipeBind2(14, 20, svc_r2.price, "1.0-0"), "");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", ctx_r2.isProduct ? \u0275\u0275pureFunction1(23, _c0, svc_r2.id) : \u0275\u0275pureFunction1(25, _c1, svc_r2.id));
    \u0275\u0275advance(4);
    \u0275\u0275property("routerLink", ctx_r2.isProduct ? \u0275\u0275pureFunction1(27, _c2, svc_r2.id) : \u0275\u0275pureFunction1(29, _c3, svc_r2.id));
  }
}
function ServiceListComponent_tr_49_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("No ", ctx_r2.isProduct ? "products" : "services", " found");
  }
}
...
var ServiceListComponent = class _ServiceListComponent {
  ...
  loadServices(page = 1) {
    ...
    const params = { page, limit: 15, type: this.itemType };
    if (this.search)
  ...
  static \u0275fac = function ServiceListComponent_Factory(t) {
    return new (t || _ServiceListComponent)(\u0275\u0275directiveInject(HttpClient), \u0275\u0275directiveInject(ToastService), \u0275\u0275directiveInject(ActivatedRoute));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ServiceListComponent, selectors: [["app-service-list"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 54, vars: 18, consts: [[1, "page-header"], [1, "page-title"], [1, "btn-primary", 3, "routerLink"], [1, "filters-bar"], [1, "search-box"], ["width", "18", "height", "18", "viewBox", "0 0 24 24", "fill", "none", "stroke", "#94a3b8", "stroke-width", "2"], ["cx", "11", "cy", "11", "r", "8"], ["d", "m21 21-4.35-4.35"], ["type", "text", 3, "ngModelChange", "input", "placeholder", "ngModel"], [3, "ngModelChange", "change", "ngModel"], ["value", ""], ["value", "1"], ["value", "0"], [1, "table-container"], ["class", "loading-overlay", 4, "ngIf"], [1, "data-table"], [4, "ngFor", "ngForOf"], [4, "ngIf"], ["class", "pagination", 4, "ngIf"], ["title", "Delete Service", "confirmText", "Delete", "type", "danger", 3, "confirmed", "cancelled", "open", "message"], ["title", "Change Status", "confirmText", "Change Status", "type", "warning", 3, "confirmed", "cancelled", "open", "message"], ["title", "Change Featured Status", "confirmText", "Confirm", "type", "info", 3, "confirmed", "cancelled", "open", "message"], [1, "loading-overlay"], [1, "spinner"], [1, "service-cell"], ["class", "thumb", "alt", "", 3, "src", 4, "ngIf"], ["class", "text-green", 4, "ngIf"], ["class", "text-muted", 4, "ngIf"], [1, "badge", "badge-clickable", 3, "click"], [1, "action-btns"], ["title", "View", 1, "btn-action", "btn-view", 3, "routerLink"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"], ["cx", "12", "cy", "12", "r", "3"], ["title", "Edit", 1, "btn-action", "btn-edit", 3, "routerLink"], ["d", "M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7"], ["d", "M18.5 2.5a2.12 2.12 0 013 3L12 15l-4 1 1-4 9.5-9.5z"], ["title", "Delete", 1, "btn-action", "btn-delete", 3, "click"], ["points", "3 6 5 6 21 6"], ["d", "M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6m3 0V4a2 2 0 012-2h4a2 2 0 012 2v2"], ["alt", "", 1, "thumb", 3, "src"], [1, "text-green"], [1, "text-muted"], ["colspan", "8", 1, "empty-state"], [1, "pagination"], [1, "page-btn", 3, "click", "disabled"], [1, "page-info"]], template: function ServiceListComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(48, ServiceListComponent_tr_48_Template, 38, 31, "tr", 16)(49, ServiceListComponent_tr_49_Template, 3, 1, "tr", 17);
      \u0275\u0275elementEnd()()();
    ...
    if (rf & 2) {
      ...
      let tmp_17_0;
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1("", ctx.isProduct ? "Products" : "Services", " Management");
      \u0275\u0275advance();
      \u0275\u0275property("routerLink", ctx.isProduct ? "/admin/products/add" : "/admin/services/add");
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1("+ Add ", ctx.isProduct ? "Product" : "Service", "");
      \u0275\u0275advance(6);
      \u0275\u0275property("placeholder", "Search " + (ctx.isProduct ? "products" : "services") + "...");
      ...
      \u0275\u0275advance(7);
      \u0275\u0275textInterpolate(ctx.isProduct ? "Product" : "Service");
      \u0275\u0275advance(14);
      ...
      \u0275\u0275advance();
      \u0275\u0275property("open", !!ctx.deletingService())("message", 'Delete "' + (((tmp_13_0 = ctx.deletingService()) == null ? null : tmp_13_0.title) || "") + '"? This cannot be undone.');
      \u0275\u0275advance();
      \u0275\u0275property("open", !!ctx.statusService())("message", 'Change status of "' + (((tmp_15_0 = ctx.statusService()) == null ? null : tmp_15_0.title) || "") + '" to ' + (((tmp_15_0 = ctx.statusService()) == null ? null : tmp_15_0.status) ? "Inactive" : "Active") + "?");
      \u0275\u0275advance();
      \u0275\u0275property("open", !!ctx.featuredService())("message", 'Mark "' + (((tmp_17_0 = ctx.featuredService()) == null ? null : tmp_17_0.title) || "") + '" as ' + (((tmp_17_0 = ctx.featuredService()) == null ? null : tmp_17_0.is_featured) ? "Not Featured" : "Featured") + "?");
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ServiceListComponent, { className: "ServiceListComponent", filePath: "src\\app\\features\\admin\\services\\service-list.component.ts", lineNumber: 182 });
})();
export {
