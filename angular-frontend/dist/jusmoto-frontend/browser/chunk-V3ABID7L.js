...
function RefundListComponent_tr_35_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((r_r2.order == null ? null : r_r2.order.invoice_number) || "#" + r_r2.order_id || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(((r_r2.user == null ? null : r_r2.user.first_name) || "") + " " + ((r_r2.user == null ? null : r_r2.user.last_name) || ""));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(9, 17, r_r2.amount, "INR", "symbol", "1.0-2"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate((r_r2.cancel_reason == null ? null : r_r2.cancel_reason.length) > 50 ? \u0275\u0275pipeBind3(12, 22, r_r2.cancel_reason, 0, 50) + "..." : r_r2.cancel_reason || "-");
    \u0275\u0275advance(3);
...
var RefundListComponent = class _RefundListComponent {
  ...
  changeStatus(refund, newStatus) {
    this.http.put(`${environment.apiUrl}/admin/refunded-orders/${refund.id}/status`, { status: Number(newStatus) }).subscribe({
      next: () => {
