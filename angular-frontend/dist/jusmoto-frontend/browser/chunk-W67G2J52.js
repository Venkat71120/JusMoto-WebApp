...
function TicketListComponent_div_17_Template(rf, ctx) {
  if (rf & 1) {
...
function TicketListComponent_tr_40_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(19, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "td")(21, "a", 22);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(22, "svg", 23);
    \u0275\u0275element(23, "path", 24)(24, "circle", 25);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((ticket_r1.user == null ? null : ticket_r1.user.first_name) ? ticket_r1.user.first_name + " " + (ticket_r1.user.last_name || "") : "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((ticket_r1.admin == null ? null : ticket_r1.admin.name) || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((ticket_r1.department == null ? null : ticket_r1.department.name) || "-");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275classProp("badge-blue", ticket_r1.status === "open")("badge-gray", ticket_r1.status === "closed");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ticket_r1.status, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(19, 19, ticket_r1.created_at, "mediumDate"));
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(22, _c0, ticket_r1.id));
  }
}
function TicketListComponent_tr_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 26);
    \u0275\u0275text(2, "No service requests found");
    \u0275\u0275elementEnd()();
  }
}
function TicketListComponent_div_42_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 27)(1, "button", 28);
    \u0275\u0275listener("click", function TicketListComponent_div_42_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function TicketListComponent_div_42_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.goToPage(ctx_r2.pagination().page + 1));
    });
...
var TicketListComponent = class _TicketListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TicketListComponent, selectors: [["app-ticket-list"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 43, vars: 6, consts: [[1, "page-header"], [1, "page-title"], [1, "filters-bar"], [1, "search-box-wrap"], ["width", "18", "height", "18", "viewBox", "0 0 24 24", "fill", "none", "stroke", "#94a3b8", "stroke-width", "2"], ["cx", "11", "cy", "11", "r", "8"], ["d", "m21 21-4.35-4.35"], ["type", "text", "placeholder", "Search service requests...", 1, "search-box", 3, "ngModelChange", "input", "ngModel"], [1, "filter-select", 3, "ngModelChange", "change", "ngModel"], ["value", ""], ["value", "open"], ["value", "closed"], [1, "table-container"], ["class", "loading-overlay", 4, "ngIf"], [1, "data-table"], [4, "ngFor", "ngForOf"], [4, "ngIf"], ["class", "pagination", 4, "ngIf"], [1, "loading-overlay"], [1, "spinner"], [1, "fw-600"], [1, "badge"], ["title", "View", 1, "action-btn", 3, "routerLink"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"], ["cx", "12", "cy", "12", "r", "3"], ["colspan", "9", 1, "empty-state"], [1, "pagination"], [1, "page-btn", 3, "click", "disabled"], [1, "page-info"]], template: function TicketListComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(17, TicketListComponent_div_17_Template, 2, 0, "div", 13);
      \u0275\u0275elementStart(18, "table", 14)(19, "thead")(20, "tr")(21, "th");
      \u0275\u0275text(22, "#");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(23, "th");
      \u0275\u0275text(24, "Title / Subject");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275template(40, TicketListComponent_tr_40_Template, 25, 24, "tr", 15)(41, TicketListComponent_tr_41_Template, 3, 0, "tr", 16);
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(42, TicketListComponent_div_42_Template, 7, 4, "div", 17);
    }
    if (rf & 2) {
      \u0275\u0275advance(8);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TicketListComponent, { className: "TicketListComponent", filePath: "src\\app\\features\\admin\\tickets\\ticket-list.component.ts", lineNumber: 119 });
})();
export {
  TicketListComponent
};
