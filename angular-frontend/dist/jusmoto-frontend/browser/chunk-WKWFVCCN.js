...
var MyCarsComponent = class _MyCarsComponent {
  ...
  }, dependencies: [CommonModule, FormsModule, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, SelectControlValueAccessor, NgControlStatus, NgModel, RouterModule], styles: [`
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MyCarsComponent, { className: "MyCarsComponent", filePath: "src\\app\\features\\profile\\my-cars\\my-cars.component.ts", lineNumber: 99 });
})();
export {
  MyCarsComponent
};
