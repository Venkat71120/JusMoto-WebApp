...
function UserDetailComponent_div_7_div_43_tr_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "a", 24);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "td");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "td")(7, "span", 25);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
...
function UserDetailComponent_div_7_div_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 18)(1, "h3");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "table", 22)(4, "thead")(5, "tr")(6, "th");
    \u0275\u0275text(7, "ID");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "th");
    \u0275\u0275text(9, "Total");
    ...
    \u0275\u0275template(17, UserDetailComponent_div_7_div_43_tr_17_Template, 15, 16, "tr", 23);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function UserDetailComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(42, "date");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(43, UserDetailComponent_div_7_div_43_Template, 18, 2, "div", 21);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_16_0;
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(36, 22, ctx_r1.user().created_at, "medium"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r1.user().last_seen ? \u0275\u0275pipeBind2(42, 25, ctx_r1.user().last_seen, "medium") : "Never");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", (tmp_16_0 = ctx_r1.user().orders) == null ? null : tmp_16_0.length);
  }
}
var UserDetailComponent = class _UserDetailComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserDetailComponent, selectors: [["app-user-detail"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 8, vars: 2, consts: [[1, "page-header"], ["routerLink", "/admin/user/all-users", 1, "back-btn"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M19 12H5"], ["points", "12 19 5 12 12 5"], ["class", "loading-center", 4, "ngIf"], [4, "ngIf"], [1, "loading-center"], [1, "spinner"], [1, "user-header-card"], [1, "user-avatar"], [1, "user-info"], [1, "user-email"], [1, "user-meta"], [1, "badge"], [1, "user-actions"], [1, "btn-toggle-status", 3, "click"], [1, "detail-grid"], [1, "detail-card"], [1, "detail-row"], [1, "label"], ["class", "detail-card", 4, "ngIf"], [1, "data-table"], [4, "ngFor", "ngForOf"], [1, "link", 3, "routerLink"], [1, "badge", 3, "ngClass"]], template: function UserDetailComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275template(6, UserDetailComponent_div_6_Template, 2, 0, "div", 5)(7, UserDetailComponent_div_7_Template, 44, 28, "div", 6);
    }
    if (rf & 2) {
      \u0275\u0275advance(6);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserDetailComponent, { className: "UserDetailComponent", filePath: "src\\app\\features\\admin\\users\\user-detail.component.ts", lineNumber: 111 });
})();
export {
  UserDetailComponent
};
