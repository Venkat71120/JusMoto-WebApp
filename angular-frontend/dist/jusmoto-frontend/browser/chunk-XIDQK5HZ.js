...
function AddressFormComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 35);
...
function AddressFormComponent_div_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 35);
...
function AddressFormComponent_option_41_Template(rf, ctx) {
  if (rf & 1) {
...
function AddressFormComponent_div_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 35);
...
function AddressFormComponent_div_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 35);
...
var AddressFormComponent = class _AddressFormComponent {
  ...
  constructor(fb, http, router, route, toast) {
    this.fb = fb;
    this.http = http;
    this.router = router;
    this.route = route;
  ...
  loadAddress(id) {
    this.http.get(`${environment.apiUrl}/user/addresses/${id}`).subscribe({
      next: (response) => {
  ...
  onSubmit() {
    ...
    const request = this.isEditing() ? this.http.put(`${environment.apiUrl}/user/addresses/${this.addressId}`, data) : this.http.post(`${environment.apiUrl}/user/addresses`, data);
    request.subscribe({
      next: () => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddressFormComponent, selectors: [["app-address-form"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 69, vars: 12, consts: [[1, "address-form-container"], [1, "back-link"], ["routerLink", "/client/address"], [1, "form-card"], [3, "ngSubmit", "formGroup"], [1, "form-row"], [1, "form-group"], ["for", "name"], ["type", "text", "id", "name", "formControlName", "name", "placeholder", "Enter full name", 1, "form-control"], ["class", "error", 4, "ngIf"], ["for", "phone"], ["type", "tel", "id", "phone", "formControlName", "phone", "placeholder", "10-digit phone number", "maxlength", "10", 1, "form-control"], ["for", "address_line1"], ["type", "text", "id", "address_line1", "formControlName", "address_line1", "placeholder", "House No., Building, Street", 1, "form-control"], ["for", "address_line2"], ["type", "text", "id", "address_line2", "formControlName", "address_line2", "placeholder", "Area, Colony, Landmark (optional)", 1, "form-control"], ["for", "city"], ["type", "text", "id", "city", "formControlName", "city", "placeholder", "City", 1, "form-control"], ["for", "state"], ["id", "state", "formControlName", "state", 1, "form-control"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["for", "pincode"], ["type", "text", "id", "pincode", "formControlName", "pincode", "placeholder", "6-digit pincode", "maxlength", "6", 1, "form-control"], ["for", "type"], ["id", "type", "formControlName", "type", 1, "form-control"], ["value", "home"], ["value", "work"], ["value", "other"], [1, "form-group", "checkbox-group"], [1, "checkbox-label"], ["type", "checkbox", "formControlName", "is_default"], [1, "form-actions"], ["type", "button", "routerLink", "/client/address", 1, "btn-outline"], ["type", "submit", 1, "btn-primary", 3, "disabled"], [1, "error"], [3, "value"]], template: function AddressFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(18, AddressFormComponent_div_18_Template, 2, 0, "div", 9)(19, AddressFormComponent_div_19_Template, 2, 0, "div", 9);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(20, "div", 6)(21, "label", 12);
      \u0275\u0275text(22, "Address Line 1 *");
      \u0275\u0275elementEnd();
      \u0275\u0275element(23, "input", 13);
      \u0275\u0275template(24, AddressFormComponent_div_24_Template, 2, 0, "div", 9);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(25, "div", 6)(26, "label", 14);
      \u0275\u0275text(27, "Address Line 2");
      \u0275\u0275elementEnd();
      \u0275\u0275element(28, "input", 15);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(29, "div", 5)(30, "div", 6)(31, "label", 16);
      \u0275\u0275text(32, "City *");
      \u0275\u0275elementEnd();
      \u0275\u0275element(33, "input", 17);
      \u0275\u0275template(34, AddressFormComponent_div_34_Template, 2, 0, "div", 9);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(35, "div", 6)(36, "label", 18);
      \u0275\u0275text(37, "State *");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(38, "select", 19)(39, "option", 20);
      \u0275\u0275text(40, "Select State");
      \u0275\u0275elementEnd();
      \u0275\u0275template(41, AddressFormComponent_option_41_Template, 2, 2, "option", 21);
      \u0275\u0275elementEnd();
      \u0275\u0275template(42, AddressFormComponent_div_42_Template, 2, 0, "div", 9);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(43, "div", 5)(44, "div", 6)(45, "label", 22);
      \u0275\u0275text(46, "Pincode *");
      \u0275\u0275elementEnd();
      \u0275\u0275element(47, "input", 23);
      \u0275\u0275template(48, AddressFormComponent_div_48_Template, 2, 0, "div", 9);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(49, "div", 6)(50, "label", 24);
      \u0275\u0275text(51, "Address Type *");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(63, "Set as default address");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(64, "div", 32)(65, "button", 33);
      \u0275\u0275text(66, "Cancel");
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ((tmp_4_0 = ctx.addressForm.get("phone")) == null ? null : tmp_4_0.touched) && ((tmp_4_0 = ctx.addressForm.get("phone")) == null ? null : tmp_4_0.errors == null ? null : tmp_4_0.errors["pattern"]));
      \u0275\u0275advance(5);
      \u0275\u0275property("ngIf", ((tmp_5_0 = ctx.addressForm.get("address_line1")) == null ? null : tmp_5_0.touched) && ((tmp_5_0 = ctx.addressForm.get("address_line1")) == null ? null : tmp_5_0.errors == null ? null : tmp_5_0.errors["required"]));
      \u0275\u0275advance(10);
      \u0275\u0275property("ngIf", ((tmp_6_0 = ctx.addressForm.get("city")) == null ? null : tmp_6_0.touched) && ((tmp_6_0 = ctx.addressForm.get("city")) == null ? null : tmp_6_0.errors == null ? null : tmp_6_0.errors["required"]));
      \u0275\u0275advance(7);
      \u0275\u0275property("ngForOf", ctx.states);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ((tmp_8_0 = ctx.addressForm.get("state")) == null ? null : tmp_8_0.touched) && ((tmp_8_0 = ctx.addressForm.get("state")) == null ? null : tmp_8_0.errors == null ? null : tmp_8_0.errors["required"]));
      \u0275\u0275advance(6);
      \u0275\u0275property("ngIf", ((tmp_9_0 = ctx.addressForm.get("pincode")) == null ? null : tmp_9_0.touched) && ((tmp_9_0 = ctx.addressForm.get("pincode")) == null ? null : tmp_9_0.errors == null ? null : tmp_9_0.errors["required"]));
      \u0275\u0275advance(19);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddressFormComponent, { className: "AddressFormComponent", filePath: "src\\app\\features\\client\\address\\address-form.component.ts", lineNumber: 288 });
})();
export {
