      ...
      <aside class="sidebar" [class.open]="sidebarOpen()">
        ...
        <nav class="sidebar-nav">
          <ul class="nav-list">
            ...
            <li>
              <a routerLink="/admin/manage/permission/role/all" routerLinkActive="active" class="nav-item" (click)="closeSidebar()">
            ...
            <li class="nav-section">FRANCHISE</li>
            <li>
              <a routerLink="/admin/franchise/list" routerLinkActive="active" class="nav-item" (click)="closeSidebar()">
