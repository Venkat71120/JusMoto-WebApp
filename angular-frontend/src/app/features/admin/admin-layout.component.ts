        ...
        <nav class="sidebar-nav">
          <ul class="nav-list">
            ...
            @if (hasPermission('vehicle.view')) {
              ...
              <li>
                <a routerLink="/admin/fuel/list" routerLinkActive="active" class="nav-item" (click)="closeSidebar()">
            ...
            <li>
              <a routerLink="/admin/quotes/all" routerLinkActive="active" class="nav-item" (click)="closeSidebar()">
            ...
            @if (hasPermission('content.view')) {
              ...
              <li>
                <a routerLink="/admin/settings/contact" routerLinkActive="active" class="nav-item" (click)="closeSidebar()">
