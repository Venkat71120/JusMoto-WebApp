    ...
    <div class="table-container">
      ...
      <table class="data-table">
        ...
        <tbody>
          <tr class="add-row">
            <td></td>
            <td><input type="text" [(ngModel)]="newName" placeholder="Fuel type name" class="inline-input"></td>
            <td><input type="text" [(ngModel)]="newImage" placeholder="Image URL" class="inline-input"></td>
            <td>
          ...
          <tr *ngFor="let item of items(); let i = index">
            ...
            <td>
              <span *ngIf="editId !== item.id">
                <img *ngIf="item.image" [src]="item.image" class="thumb" alt="">
                <span *ngIf="!item.image" class="text-muted">-</span>
              </span>
              <input *ngIf="editId === item.id" type="text" [(ngModel)]="editImage" placeholder="Image URL" class="inline-input">
            </td>
            <td>
          ...
          <tr *ngIf="items().length === 0 && !loading()">
            <td colspan="4" class="empty-state">No fuel types found</td>
          </tr>
        </tbody>
      </table>
    </div>
