...
@Component({
      ...
      <aside class="sidebar" [class.open]="sidebarOpen()">
        ...
        <nav class="sidebar-nav">
          <ul class="nav-list">
            ...
            <li>
              <a routerLink="/client/quotes" routerLinkActive="active" class="nav-item" (click)="closeSidebar()">
                <svg width="19" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
      ...
      <main class="main-content">
        ...
        <header class="main-header">
          ...
          <div class="header-right">
            <a routerLink="/client/cart" class="header-icon cart-icon">
  ...
  styles: [`
    * {
    ...
    /* Global select/dropdown styling for all client pages */
    :host ::ng-deep select {
      appearance: none;
