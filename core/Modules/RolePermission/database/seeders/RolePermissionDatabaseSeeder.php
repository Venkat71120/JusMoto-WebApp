...
class RolePermissionDatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Admin form builder manage
        $admin_form_builder_permissions = [
            'form-list',
            'form-edit',
            'form-edit',
            'form-delete',
        ...
        foreach ($admin_form_builder_permissions as $permission) {
            Permission::updateOrCreate([
                'menu_name' => 'Admin Form Builder Manage',
                'name' => $permission,
                'guard_name' => 'admin'
            ]);
        }
        // Admin widget builder manage
        $admin_widget_builder_permissions = [
            'widget-list',
            'widget-add',
            'widget-update',
            'widget-delete'
        ];
        foreach ($admin_widget_builder_permissions as $permission) {
            Permission::updateOrCreate([
                'menu_name' => 'Admin Widget Builder Manage',
                'name' => $permission,
                'guard_name' => 'admin'
            ]);
        }

        // Admin menu builder manage
        $admin_menu_builder_permissions = [
            'menu-list',
            'menu-edit',
            'menu-delete',
        ];
        foreach ($admin_menu_builder_permissions as $permission) {
            Permission::updateOrCreate([
                'menu_name' => 'Admin Menu Builder Manage',
                'name' => $permission,
                'guard_name' => 'admin'
            ]);
        }
        ...
        $admin_product_permissions = [
            ...
            'admin-product-published-status-change',
            'admin-product-status-change',
        ];
        foreach ($admin_product_permissions as $permission) {
            Permission::updateOrCreate([
                'menu_name' => 'Admin Products Manage',
                'name' => $permission,
                'guard_name' => 'admin'
            ]);
        }
        ...
        foreach ($admin_brand_permissions as $permission) {
            Permission::updateOrCreate([
                'menu_name' => 'Admin Brand Manage',
                'name' => $permission,
                'guard_name' => 'admin'
            ]);
        }
        ...
        // Car manage
        $admin_car_permissions = [
            'admin-car-list',
            'admin-car-add',
            'admin-car-edit',
            'admin-car-delete',
            'admin-car-bulk-delete',

        ];
        foreach ($admin_car_permissions as $permission) {
            Permission::updateOrCreate([
                'menu_name' => 'Admin Car Manage',
                'name' => $permission,
                'guard_name' => 'admin'
            ]);
        }
        ...
        // Engine manage
        $admin_engine_permissions = [
            'admin-engine-list',
            'admin-engine-add',
            'admin-engine-edit',
            'admin-engine-delete',
            'admin-engine-bulk-delete',

        ];
        foreach ($admin_engine_permissions as $permission) {
            Permission::updateOrCreate([
                'menu_name' => 'Admin Engine Manage',
                'name' => $permission,
                'guard_name' => 'admin'
            ]);
        }
         // Fual manage
         $admin_fual_permissions = [
            'admin-fual-list',
            'admin-fual-add',
            'admin-fual-edit',
            'admin-fual-delete',
            'admin-fual-bulk-delete',

        ];
        foreach ($admin_fual_permissions as $permission) {
            Permission::updateOrCreate([
                'menu_name' => 'Admin Fual Manage',
                'name' => $permission,
                'guard_name' => 'admin'
            ]);
        }

         // Delivery Charge manage
         $admin_delivery_charge_permissions = [
            'delivery-charge-settings',

        ];
        foreach ($admin_delivery_charge_permissions as $permission) {
            Permission::updateOrCreate([
                'menu_name' => 'Delivery Charge Settings',
                'name' => $permission,
                'guard_name' => 'admin'
            ]);
        }
         ...
         // Refund manage
         $admin_refund_permissions = [
            'refund-payment-gateway-list',
            'refund-payment-gateway-add',
            'refund-payment-gateway-edit',
            'refund-payment-status-change',
            'refund-payment-gateway-delete',

        ];
        foreach ($admin_refund_permissions as $permission) {
            Permission::updateOrCreate([
                'menu_name' => 'Refund',
                'name' => $permission,
                'guard_name' => 'admin'
