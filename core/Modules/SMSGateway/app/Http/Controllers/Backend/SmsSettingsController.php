...
class SmsSettingsController extends Controller
{
    ...
    public function send_test_sms(Request $request)
    {
        ...
        try {
           $result= $this->sendSms([$request->test_phone_number, __('Test SMS From '.get_static_option('site_title'))], 'otp');
           if($result==true)
           {
             return back()->with(FlashMsg::item_new('Test SMS sent successfully'));
           }
           else
           {
             return back()->with(FlashMsg::item_delete('Failed to send test SMS.'));
           }
