        ...
        if ($has_manual_payment_gateway) {
            $output .= '<div class="manual_payment_gateway_extra_field">
                            <div class="form-group single-input d-none manual_transaction_id mt-4">
                                ...
                                <input type="text" name="trasaction_id"     class="form-control form--control mt-2 trasaction_id"  placeholder="'.__('Transaction ID').'">
                                <input type="file" name="manual_payment_image"  class="form-control form--control mt-2 icofont-line-height trasaction_attachment"    placeholder="'.__('Transaction Attachment').'" accept="image/*">
                           </div>
                         </div>';
        }
