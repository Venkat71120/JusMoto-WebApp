...
class LoginController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        $user = User::with('account_deactivates')
            ->select('id','first_name', 'last_name', 'email', 'phone', 'email_verified', 'username', 'password')
        ...
        $userData = $user->only(['id', 'first_name', 'last_name', 'email', 'phone', 'email_verified', 'username']);
