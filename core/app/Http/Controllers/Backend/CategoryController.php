...
class CategoryController extends Controller
{
        ...
        if($request->isMethod('post')){
            $request->validate(
                [
                    ...
                    'category_type'=>'required|integer|between:0,2'
                ],
                [
                    'name.unique' => __("Category Already Exists."),
                    'slug.unique' => __("Slug Already Exists."),
                    'category_type.required' => __("Category Type is required"),
                ]
            );
            ...
            return redirect()->back()->with(FlashMsg::item_new(__('New Category Added')));
        }
    ...
    public function editCategory(Request $request, $id=null)
    {
        if($request->isMethod('post')){
            ...
            return redirect()->back()->with(FlashMsg::item_new(__('Category Update Success')));
        }
    ...
    public function deleteCategory($id){
        ...
        return redirect()->back()->with(FlashMsg::item_new(__('Category Deleted Success')));
    }
