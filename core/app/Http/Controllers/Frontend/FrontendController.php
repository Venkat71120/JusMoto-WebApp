...
use App\Models\User;
use Modules\Blog\app\Services\BlogsService;
...
class FrontendController extends Controller
{
    ...
    {
        return match ($slug){
            'blogs' => BlogsService::handleBlogPage(request(),$slug),
            default => $this->handleDynamicPage($slug)
        };
    }

    private function handleDynamicPage($slug)
    {
