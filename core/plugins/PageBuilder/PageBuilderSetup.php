...
class PageBuilderSetup
{
    private static function register_widgets(): array
    {
        ...
        //check module wise widget by set condition
        $addons = [
            \plugins\PageBuilder\Addons\Contact\ContactInfoSection::class,
            \plugins\PageBuilder\Addons\Contact\ContactMessage::class,
            \plugins\PageBuilder\Addons\About\AboutUsSection::class,
            \plugins\PageBuilder\Addons\About\AchivementSection::class,
            \plugins\PageBuilder\Addons\About\OurMissionSection::class,
            \plugins\PageBuilder\Addons\About\ExpertMemberSection::class,
            ...
            \plugins\PageBuilder\Addons\Home\HeroSection::class,
            \plugins\PageBuilder\Addons\Home\FeatureSection::class,
            \plugins\PageBuilder\Addons\Home\ServiceSection::class,
            \plugins\PageBuilder\Addons\Home\ProductSection::class,
            \plugins\PageBuilder\Addons\Home\ChooseUsSection::class,
            \plugins\PageBuilder\Addons\Home\AppVersionSection::class,
            \plugins\PageBuilder\Addons\Home\ReviewSection::class,
            \plugins\PageBuilder\Addons\Home\BlogSection::class,
            \plugins\PageBuilder\Addons\Home\ReadyToGetServiceSection::class,
        ];
