    ...
    */
    ...
    $(document).ready(function() {
        ...
        $(document).on('keyup','#search_sidebarList',function (){
            let searchValues = $(this).val().toLowerCase().trim();

            if (!searchValues) {
                $('.dashboard__bottom__list li').show();
                $('.dashboard__bottom__list li.has-children').removeClass('open show');
                $('.dashboard__bottom__list li .submenu').hide();
                return;
            }
            ...
            $('.dashboard__bottom__list li').each(function(){
                ...
                if(text.indexOf(searchValues) !== -1){
                    li.show();
                    li.parents('li.has-children').addClass('open show');
                    li.parents('li.has-children').children('.submenu').show();
                } else {
                    li.hide();
                }
            });
