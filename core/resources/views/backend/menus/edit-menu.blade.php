                                            ...
                                            <div class="accordion accordion-wrapper" id="add_menu_item_accordion">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-header" id="id_7188851-page-list-items">
                                                        <h2 class="mb-0"><button class="btn btn-link" type="button" data-bs-toggle="collapse" data-bs-target="#id_7188851-page-list-items-content" aria-expanded="true">{{__('Static Pages')}}</button></h2>
                                                    </div>
                                                            ...
                                                            <ul class="page-list-ul">
                                                                <li>
                                                                    <label class="menu-item-title">
                                                                        <input type="checkbox" class="menu-item-checkbox" data-title="Service" data-url="@url/services"> {{ __('Service') }}
                                                                    </label>
                                                                </li>
                                                                <li>
                                                                    <label class="menu-item-title">
                                                                        <input type="checkbox" class="menu-item-checkbox" data-title="Products" data-url="@url/products"> {{ __('Products') }}
                                                                    </label>
                                                                </li>
                                                                <li>
                                                                    <label class="menu-item-title">
                                                                        <input type="checkbox" class="menu-item-checkbox" data-title="Blogs" data-url="@url/blogs"> {{ __('Blogs') }}
                                                                    </label>
                                                                </li>
                                                                <li>
                                                                    <label class="menu-item-title">
                                                                        <input type="checkbox" class="menu-item-checkbox" data-title="Terms Conditions" data-url="@url/terms-and-conditions"> {{ __('Term & Conditions') }}
                                                                    </label>
                                                                </li>
                                                            </ul>
