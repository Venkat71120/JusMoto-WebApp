    ...
    <div class="dashboard__card__body custom__form p-2">
        <div class="form__input__single d-flex" id="choose_option">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="choose1" id="service_select" value="service_select">
                <label class="form-check-label" for="service_select">
                    {{ __('Service') }}
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="choose2" id="product" value="product">
...
<div class="dashboard__card  d-none mt-3" id="product_choose">
    <div class="dashboard__card__header p-2">
        
        <h4 class="dashboard__card__title">{{ __('Offer Product') }}</h4>
