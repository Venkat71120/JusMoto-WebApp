        ...
        <div class="dashboard__card">
            ...
            <div class="dashboard__card__body custom__form mt-4 p-2">
                ...
                <div class="form-group mt-2">
                    ...
                    <textarea type="text" class="form-control" id="subtitle" name="subtitle" placeholder="Order Subtitle">{{ old('subtitle', $offer->subTitle) }}</textarea>
                </div>
                <div class="form-group mt-2">
                    <label for="percentage">{{ __('Offer Percentage') }}</label>
                    <input type="number" class="form-control" id="percentage"
                           name="percentage" value="{{$offer->offerPercentage}}" placeholder="Offer Percentage">
                </div>
                <div class="form-group mt-2">
