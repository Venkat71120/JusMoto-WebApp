                ...
                <div class="dashboard__inner__header">
                    <div class="dashboard__inner__header__flex">
                        <div class="dashboard__inner__header__left">
                            <h4 class="dashboard__inner__header__title">{{ __('All Reviews') }}</h4>
                       </div>
                        <div class="dashboard__inner__header__right">
                            <div class="d-flex text-right w-100 mt-3">
                                <input class="form__control notice_string_search" name="string_search" id="string_search" placeholder="{{ __('Search Using rating') }}">
                            </div>
                       </div>
                   </div>
                 </div>
                ...
                <div class="tableStyle_three mt-4">
                    <div class="table_wrapper custom_Table">
                        <div class="search_notice_result">
                            @include('backend.pages.admin.review.search-review')
                        </div>
                    </div>
                </div>
            </div>
        ...
        (function(){
            ...
            $(document).ready(function(){
                ...
                function notices(page){
                    $.ajax({
                        url:"{{ route('admin.review.paginate').'?page='}}" + page,
                        success:function(res){
                            $('.search_notice_result').html(res);
                        }
                    });
