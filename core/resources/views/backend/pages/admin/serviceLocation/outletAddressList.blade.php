                    ...
                    <div class="dashboard__inner__header">
                        <div class="dashboard__inner__header__flex">
                            <div class="dashboard__inner__header__left">
                                <h4 class="dashboard__inner__header__title">{{ __('All Outlets') }}</h4>
                            ...
                            <div class="dashboard__inner__header__right">
                                <div class="btn-wrapper">
                                    <a href="{{ route('admin.outletAddress.add') }}" class="btn_bg_blue">
                    ...
                    <div class="tableStyle_three">
                        <div class="table-responsive">
                            <div class="search_notice_result">
                                @include('backend.pages.admin.serviceLocation.search-outlet')
                            </div>
                        </div>
                    </div>
                </div>
...
@section('scripts')
    @can('admin-outlet-bulk-delete')
        <x-bulk-action.bulk-action-js :url="route('admin.outlet.bulk.action')"/>
    @endcan
        ...
        (function(){
            ...
            $(document).ready(function(){
                            ...
                            beforeSend: function() {
                                $('.search_notice_result').html(`
                                    <div class="empty-state">
                                        ...
                                        <p style="margin-top: 16px;">{{ __('Searching...') }}</p>
                                    </div>
                                `);
                            },
                ...
                function notices(page){
                    $.ajax({
                        url: "{{ route('admin.outlet.paginate.data') }}?page=" + page,
                        beforeSend: function() {
                            $('.search_notice_result').html(`
                                <div class="empty-state">
                                    <div class="spinner-border"></div>
