            ...
            <form action="{{route('admin.email.user.verify.template')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="tab-content margin-top-30">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control summernote" id="user_email_verify_message" name="user_email_verify_message">{!! get_static_option('user_email_verify_message') ?? '<p>Hello @name,</p></p>Here is your verification code Verification Code: @email_verify_tokn</p>'  !!}</textarea>
                    </div>
                    <div class="d-grid">
