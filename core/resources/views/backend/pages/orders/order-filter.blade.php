    ...
    <div class="filter-header">
            ...
            <div class="order-tabs">
                <ul class="tab-list">
                    ...
                    <li class="{{ $current_status === '0' ? 'active' : '' }}">
                        <a href="{{ route('admin.service.all.orders', ['status' => '0']) }}">
                            {{ __('Pending') }}
                            <span class="badge">{{ $total_pending_order }}</span>
                        </a>
                    </li>
                    <li class="{{ $current_status === '2' ? 'active' : '' }}">
                        <a href="{{ route('admin.service.all.orders', ['status' => '2']) }}">
                            {{ __('Completed') }}
                            <span class="badge">{{ $total_completed_order }}</span>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="filter-right">
            <div class="search-box">
                <input type="text" class="search-input string_search" id="string_search" placeholder="{{ __('Search orders...') }}">
