...
<div class="row g-4 mt-0 justify-content-center">
    <div class="col-xl-8 col-lg-10 mt-0">
        <div class="dashboard__card bg__white padding-20 radius-10">
            ...
            <form action="{{route('admin.order.settings')}}" method="POST" class="validateForm" enctype="multipart/form-data" id="orderSettingsForm">
                @csrf
                
                <!-- Info Message -->
                <div class="text-info mb-4">
                    <i class="las la-info-circle"></i>
                    {{ __('Customize the invoice page text and appearance below.') }}
                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   name="bill_to_title"  
                                   class="form-control" 
                                   value="{{get_static_option('bill_to_title')}}" 
                                   id="bill_to_title"
                                   placeholder="{{ __('e.g., Billing Address') }}">
                            <small class="form-text text-muted">{{ __('Title for the billing section') }}</small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   name="ship_to_title"  
                                   class="form-control" 
                                   value="{{get_static_option('ship_to_title')}}" 
                                   id="ship_to_title"
                                   placeholder="{{ __('e.g., Shipping Address') }}">
                            <small class="form-text text-muted">{{ __('Title for the shipping section') }}</small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   name="invoice_title"  
                                   class="form-control" 
                                   value="{{get_static_option('invoice_title')}}" 
                                   id="invoice_title"
                                   placeholder="{{ __('e.g., INVOICE') }}">
                            <small class="form-text text-muted">{{ __('Main invoice title') }}</small>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   class="form-control" 
                                   value="{{get_static_option('invoice_no_title')}}" 
                                   id="invoice_no_title"
                                   placeholder="{{ __('e.g., Invoice Number') }}">
                            <small class="form-text text-muted">{{ __('Title for the invoice number field') }}</small>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="order_invoice_notes">
                                ...
                                {{__('Invoice Notes for Admin')}}
                            </label>
                            <textarea name="order_invoice_notes" 
                                      id="order_invoice_notes" 
                                      class="form-control"
                                      placeholder="{{ __('Add any additional notes or instructions for the admin...') }}">{{ get_static_option('order_invoice_notes') }}</textarea>
                            <small class="form-text text-muted">{{ __('These notes will appear on the invoice') }}</small>
                        </div>
                    </div>
                </div>
        ...
        <div class="dashboard__card bg__white padding-20 radius-10">
            ...
            <div class="invoice-preview">
                <div class="preview-header">
                    <span class="preview-badge">{{ get_static_option('invoice_title') ?? 'INVOICE' }}</span>
                </div>
                <div class="preview-body">
                    <div class="row">
                        <div class="col-6">
                            <strong>{{ get_static_option('bill_to_title') ?? 'Bill To' }}:</strong>
                            <p class="text-muted">John Doe<br>123 Main St<br>New York, NY 10001</p>
                        </div>
                        <div class="col-6">
                            <strong>{{ get_static_option('ship_to_title') ?? 'Ship To' }}:</strong>
                    ...
                    <div class="preview-footer mt-3">
                        <small class="text-muted">
                            <i class="las la-info-circle"></i>
                            {{ get_static_option('order_invoice_notes') ?? 'Preview of how your invoice will appear' }}
                        </small>
                    </div>
                </div>
            </div>
