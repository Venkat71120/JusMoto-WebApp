                    ...
                    <div class="table_wrapper custom_Table">
                      <div class="dashboard__body">
                        <div class="dashboard__inner">
                           ...
                           @if(optional($suborder->subOrderLocations)->count() > 0)
                              <div class="mt-2">
                                ...
                                <div class="table_wrapper table-responsive">
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($suborder->subOrderLocations as $location)
                                            <tr>
                                                <td>{{ $location->id }}</td>
                                                <td>{{ $location->sub_order_id }}</td>
                                                <td>
                                                    <div class="table_customer">
                                                        <div class="table_customer__flex">
                                                            <div class="table_customer__contents">
                                                                <h6 class="table_customer__title">{{ __('State:') }} {{ $location->state?->state }} </h6>
                                                                <h6 class="table_customer__title">{{ __('City:') }} {{ $location->city?->city }}</h6>
                                                                <h6 class="table_customer__title">{{ __('Area:') }} {{ $location->area?->area }}</h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>{{ $location->emergency_phone }}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
