        ...
        <div class="col-xl-6 col-lg-6">
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="form__input__flex">
                        <div class="card-body">
                            <div class="alert alert-info mt-3">{{__('if you enable page builder, your  page will load only page builder content.')}}</div>
                            <div class="form-group">
                                <label for="page_builder_status"><strong>{{__('Enable/Disable Page Builder')}}</strong></label>
                                <label class="switch">
                                    <input type="checkbox" name="page_builder_status"
                                           @if(!empty(get_static_option('page_builder_status'))) checked @endif >
