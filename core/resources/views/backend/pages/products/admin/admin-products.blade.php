                ...
                <div class="dashboard__inner__header">
                    <div class="dashboard__inner__header__flex">
                        <div class="dashboard__inner__header__left">
                            <h4 class="dashboard__inner__header__title">{{ __('All Products') }}</h4>
                        ...
                        <div class="dashboard__inner__header__right">
                            <div class="btn-wrapper">
                                <a href="{{ route('admin.add.new.product') }}" class="cmnBtn btn_5 btn_bg_blue radius-5">{{ __('Add Product') }}</a>
                            </div>
                ...
                <div class="tableStyle_three mt-4">
                    <div class="table_wrapper custom_Table">
                        <div class="search_notice_result">
                            @include('backend.pages.products.admin.search-product')
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    @can('user-product-bulk-delete')
        <x-bulk-action.bulk-action-js :url="route('admin.bulk.action.product')"/>
    @endcan
        ...
        (function(){
            ...
            $(document).ready(function(){
                ...
                function notices(page){
                    $.ajax({
                        url:"{{ route('admin.paginate.product').'?page='}}" + page,
                        success:function(res){
                            $('.search_notice_result').html(res);
                        }
                    });
