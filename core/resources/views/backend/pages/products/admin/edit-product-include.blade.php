    ...
    <div class="row">
        <div class="col-12">
                    ...
                    @foreach($product->includes as $include)
                        <div class="single-dashboard-input what-include-element">
                            <div class="single-info-input margin-top-20">
                                ...
                                <input class="form-control" type="text" name="include_product_title[]" value="{{ $include->title }}" placeholder="{{__('Product title')}}">
                            </div>
            ...
            <div class="single-settings margin-top-40">
                <h5 class="input-title"> {{__('Add Products Additional Info')}} </h5>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="d-flex g-2">
                                            <div class="single-info-input margin-top-20 me-2">
                                                <label>{{ __('Title') }}</label>
                                                <input class="form-control" type="text" name="product_info_title[]" value="{{ $additional->title }}">
                                            </div>
                                    ...
                                    <div class="col-lg-12 mt-4">
                                        <div class="upload-img">
                                            ...
                                            <input type="hidden" name="product_information_image[]" value="{{ $additional->image }}">
                ...
                <div class="btn-wrapper margin-top-20">
                    <a href="javascript:void(0)" class="cmnBtn btn_5 btn_bg_blue radius-5 add-product-info"> {{__('Add More')}} </a>
                </div>
            </div>

            <div class="single-settings margin-top-40">
                <h5 class="input-title"> {{__('Add Products Specification')}} </h5>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="d-flex g-2">
                                            <div class="single-info-input margin-top-20 me-2">
                                                <label>{{ __('Title') }}</label>
                                                <input class="form-control" type="text" name="product_specification_title[]" value="{{ $additional->title }}">
                                            </div>
                                    ...
                                    <div class="col-lg-12 mt-4">
                                        <div class="upload-img">
                                            ...
                                            <input type="hidden" name="product_specification_image[]" value="{{ $additional->image }}">
                                            <button type="button" class="btn btn-info media_upload_form_btn"
                                                data-btntitle="{{__('Select Image')}}"
                                                data-modaltitle="{{__('Upload Image')}}"
                                                data-bs-toggle="modal"
                ...
                <div class="btn-wrapper margin-top-20">
                    <a href="javascript:void(0)" class="cmnBtn btn_5 btn_bg_blue radius-5 add-product-specification"> {{__('Add More')}} </a>
                </div>
            </div>
