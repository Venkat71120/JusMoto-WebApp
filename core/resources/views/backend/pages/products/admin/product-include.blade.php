                ...
                <div class="append-additional-includes">
                    <div class="single-dashboard-input what-include-element">
                        <div class="single-info-input margin-top-20">
                            ...
                            <input class="form-control" type="text" name="include_product_title[]" placeholder="{{__('Product title')}}">
                        </div>
                    ...
                    <div class="single-dashboard-input product-info">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="single-info-input margin-top-20">
                                    <label>{{ __('Title') }}</label>
                                    <input class="form-control" type="text" name="product_info_title[]" placeholder="{{__('Product Information title')}}">
                                </div>
                            </div>
                    ...
                    <div class="single-dashboard-input product-specification">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="single-info-input margin-top-20">
                                    <label>{{ __('Title') }}</label>
                                    <input class="form-control" type="text" name="product_specification_title[]" placeholder="{{__('Product Specification title')}}">
                                </div>
                            </div>
                            <div class="col-lg-12 mt-4">
                                <div class="upload-img">
