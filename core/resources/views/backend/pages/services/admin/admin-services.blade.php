...
@section('content')
    <div class="services-page">
        ...
        <div class="page-header-card">
            <div>
                <h1 class="page-title">
                    <span>{{ __('Admin') }}</span> {{ __('All Services') }}
                </h1>
                <p class="page-subtitle">{{ __('Manage and organize all your services from one place') }}</p>
            </div>
            ...
            <div class="action-bar">
                ...
                <div class="action-right">
                    ...
                    <!-- Add Service Button -->
                    <a href="{{ route('admin.add.new.service') }}" class="add-service-btn">
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.swal_status_change', function(e) {
                    ...
                    Swal.fire({
                        ...
                        text: '{{ __("Are you sure you want to change the status? This action can be reversed later.") }}',
                        icon: 'question',
                            ...
                            if (res.status === 'nothing' || $(res).find('tbody tr').length === 0) {
                                $('.search_notice_result').html(`
                                    <div class="nothing-found">
                                        ...
                                        <p>{{ __('No services found matching your search') }}</p>
                                    </div>
                                `);
                            } else {
                        ...
                        error: function() {
                            $('.search_notice_result').html(`
                                <div class="nothing-found">
                                    ...
                                    <p>{{ __('An error occurred. Please try again.') }}</p>
                                </div>
                            `);
                        }
                    });
                ...
                $('#bulk_action_apply').on('click', function() {
                    ...
                    if (bulkAction === 'delete' && selectedIds.length > 0) {
                        Swal.fire({
                            title: '{{ __("Confirm Bulk Delete") }}',
                            text: '{{ __("Are you sure you want to delete the selected items? This action cannot be undone.") }}',
                            icon: 'warning',
                            showCancelButton: true,
                            confirmButtonColor: '#e31b23',
                            cancelButtonColor: '#6b7280',
                        ...
                        Swal.fire({
                            ...
                            text: '{{ __("Please select at least one item to perform bulk action.") }}',
                            icon: 'info',
                            confirmButtonColor: '#e31b23'
                        });
                    }
