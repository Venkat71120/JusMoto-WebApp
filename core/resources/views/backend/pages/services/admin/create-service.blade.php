        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status == 'success') {
                    ...
                    {
                            $('#search_service_car_result').empty(); // Clear previous results
                            ...
                            $.each(res.cars, function (key, car) {
                                ...
                                let card = `
                                    <div class="card mt-2 mb-4 w-100 car-card-filter ${hiddenElement}" data-index="${key}"  id="session_service_car_card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-3">
