        ...
        <div class="col-lg-8">
            ...
            <div class="form-card">
                <div class="form-card-header">
                    ...
                    <h5 class="header-title">{{ __('Basic Information') }}</h5>
                </div>
                <div class="form-card-body">
                    <!-- Title -->
                    <div class="form-group">
                        <label class="form-label">{{ __('Title') }} <span class="required-star">*</span></label>
                        <input type="text" class="form-control" name="title" id="title" 
                               value="{{ $service->title }}" 
                               placeholder="{{ __('e.g. Premium Car Wash Service') }}">
                    </div>

                    <!-- Permalink -->
                    <div class="permalink-wrapper">
                        <div class="permalink-label">{{ __('Permalink') }} <span class="required-star">*</span></div>
                        <div class="permalink-content">
                            <span id="slug_show" class="permalink-url">{{ url('/service/') }}/{{ $service->slug }}</span>
                            <button class="btn-icon edit-slug-btn slug_edit_button" title="{{ __('Edit') }}">
                                <i class="las la-pen"></i>
                            </button>
                        </div>
                        <div class="permalink-edit-wrapper" style="display: none;">
                            <input class="form-control permalink-input listing_slug" name="slug" 
                                   value="{{ $service->slug }}" id="slug" type="text">
                            <button class="btn-primary btn-sm slug_update_button mt-2">{{ __('Update') }}</button>
                        </div>
                    </div>

                    <!-- Category -->
                    <div class="form-group">
                        <label class="form-label">{{ __('Category') }} <span class="required-star">*</span></label>
            ...
            <div class="form-card">
                <div class="form-card-header">
                    ...
                    <h5 class="header-title">{{ __('Description') }}</h5>
                </div>
                <div class="form-card-body">
                    <div class="form-group">
                        <label class="form-label">{{ __('Detailed Description') }} <span class="required-star">*</span></label>
                        <textarea class="form-control textarea" name="description" 
                                  placeholder="{{ __('Describe your service in detail...') }}" 
            ...
            <div class="form-card">
                <div class="form-card-header">
                    ...
                    <h5 class="header-title">{{ __('Additional Information') }}</h5>
                </div>
                <div class="form-card-body">
                    <div class="row">
                        <!-- Video URL -->
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <small class="form-hint">
                                    ...
                                    {{ __('Example: https://www.youtube.com/watch?v=IcM8_Llgxf4&t=1s') }}
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="featured-wrapper">
                                <label class="featured-checkbox">
                                    <input type="checkbox" name="is_featured" id="is_featured" 
                                           value="1" @if($service->is_featured == 1) checked @endif>
                                    <span class="checkbox-custom"></span>
                                    <span class="checkbox-label">{{ __('Featured Service') }}</span>
                                </label>
                                <small class="form-hint">{{ __('Mark as featured to highlight') }}</small>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-card">
                <div class="form-card-header">
                    ...
                    <h5 class="header-title">{{ __('Pricing') }}</h5>
                </div>
                <div class="form-card-body">
                    <!-- Price -->
                    <div class="form-group">
                        <label class="form-label">{{ __('Regular Price') }} <span class="required-star">*</span></label>
                        <div class="input-with-icon">
                            ...
                            <input type="number" class="form-control with-icon" name="price" id="price" 
                                   value="{{ $service->price }}" placeholder="0.00" step="0.01">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="number" class="form-control with-icon" name="discount_price" id="discount_price" 
                                   value="{{ $service->discount_price }}" placeholder="0.00" step="0.01">
                        </div>
                        <small class="form-hint">{{ __('Leave empty if no discount') }}</small>
                    </div>
                </div>
            </div>
            ...
            <div class="form-card">
                <div class="form-card-header">
                    ...
                    <h5 class="header-title">{{ __('Service Details') }}</h5>
                </div>
                <div class="form-card-body">
                    <!-- Duration -->
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="duration" id="duration" 
                               value="{{ $service->duration }}" placeholder="{{ __('e.g. 2 hours, 30 minutes') }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="max_qty" id="max_qty" 
                               value="{{ $service->max_qty }}" placeholder="{{ __('e.g. 10') }}" min="1">
                    </div>
                </div>
            </div>
            ...
            <div class="form-card">
                <div class="form-card-header">
                    ...
                    <h5 class="header-title">{{ __('Main Image') }}</h5>
                </div>
                <div class="form-card-body">
                    <div class="media-upload-card">
                        ...
                        <input type="hidden" name="image" id="service_image" value="{{ $service->image ?? '' }}">
                        ...
                        <div class="image-info">
                            <small><i class="las la-info-circle"></i> {{ __('Format: jpg, jpeg, png, gif, webp') }}</small>
                            <small><i class="las la-image"></i> {{ __('Recommended: 810x450px') }}</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-card">
                <div class="form-card-header">
                    ...
                    <h5 class="header-title">{{ __('Gallery Images') }}</h5>
                </div>
                <div class="form-card-body">
                    <div class="media-upload-card">
                        <div class="gallery-preview" id="galleryPreview">
                            ...
                            @if(empty($service->gallery_images))
                                <img src="{{ asset('assets/frontend/img/gallery/uploadeImg.png') }}" alt="preview" class="preview-img">
                            @endif
                        </div>
                        <input type="hidden" name="gallery_images" id="gallery_images" value="{{ $service->gallery_images }}">
                        <button type="button" class="upload-btn media_upload_form_btn"
                                ...
                                data-modaltitle="{{ __('Upload Images') }}"
                                data-bs-toggle="modal"
                                data-bs-target="#media_upload_modal">
                            <i class="las la-cloud-upload-alt"></i>
