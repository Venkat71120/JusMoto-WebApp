        ...
        <div class="col-lg-8">
            ...
            <div class="form__input__single mt-3">
                <div class="input-form input-form2 permalink_label">
                    ...
                    <input class="listing_slug form__control radius-5" name="slug" value="{{$service->slug}}" id="slug" type="text">
        ...
        <div class="col-lg-4">
            ...
            <div class="col-lg-12 col-md-12 mt-5">
                <div class="form__input__single position-relative">
                    ...
                    <div class="input-form input-form2">
                        <input type="number" class="form__control radius-5" name="price" id="price" value="{{ $service->price }}" placeholder="{{__('0.00')}}" step="0.01">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12 mt-4">
                <div class="form__input__single position-relative">
                    ...
                    <div class="input-form input-form2">
                        <input type="number" class="form__control radius-5" name="discount_price" id="discount_price" value="{{ $service->discount_price }}" placeholder="{{__('0.00')}}" step="0.01">
                    </div>
                </div>
            </div>
             ...
             <div class="col-lg-12 col-md-12 mt-4">
                <div class="form__input__single position-relative">
                    ...
                    <div class="input-form input-form2">
                        <input type="text" class="form__control radius-5" name="duration" id="duration" value="{{ $service->duration }}" placeholder="{{ __('e.g.hour,miute,second') }}">
                    </div>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 mt-4">
                <div class="form__input__single position-relative">
                    ...
                    <div class="input-form input-form2">
                        <input type="text" class="form__control radius-5" name="max_qty" id="max_qty" value="{{ $service->max_qty }}" placeholder="{{ __('Enter Max Quantity')}}">
                    </div>
                </div>
            </div>
