        ...
        (function ($) {
            ...
            $(document).ready(function () {
                ...
                $('#addEditAllVariant').on('click', function () 
                {
                    ...
                    $.ajax({
                                method: 'post',
                                url: "{{ route('admin.editCarService.add') }}",
                                data: {
                                    variant_id:'all',
                ...
                $('#edit_filterBtn').on('click', function () {
                    ...
                    $.ajax({
                        url: "{{ route('admin.editCarService.filter') }}",
                        method: 'GET',
                                ...
                                else
                                {
                                         ...
                                         if(length>5)
                                        {
                                            let loadMore=` <div class="text-center mt-3">
                                                <button type="button" class="btn btn-primary" id="loadMoreCarsForServiceFilter">{{ __('Load More') }}</button>
                                            </div>`;
