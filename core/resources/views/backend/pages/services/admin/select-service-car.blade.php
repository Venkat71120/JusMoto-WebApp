<div class="tab-pane fade step" id="car" role="tabpanel" aria-labelledby="select-car-tab">
                            ...
                            <div class="col-lg-3 mt-3">
                                <div class="upload-img" id="service_product_img">
                                    <div class="media-upload-btn-wrapper">
                                        <div class="img-wrap">
                                            <img src="{{ asset('assets/frontend/img/gallery/single-image-upload.png') }}" id="service_car_demo_image" alt="images" class="w-100">
                                        </div>
    ...
    <div class="btn_wrapper d-flex justify-content-end gap-3 mt-4">
        ...
        <button type="submit" class="cmnBtn btn_5 btn_bg_blue radius-5 validate_subscription_type">{{__('Add Service')}}</button>
    </div>
