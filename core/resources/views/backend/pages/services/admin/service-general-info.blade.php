    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="form__input__single">
                <label class="form__input__single__label">{{ __('Title') }} <span class="required-star">*</span></label>
            ...
            <div class="form__input__single mt-2">
                <div class="input-form input-form2 permalink_label">
                    <label for="title" class="form__input__single__label text-dark"> {{__('Permalink')}}  <span class="required-star">*</span>  </label>
            ...
            <div class="d-flex justify-content-between gap-3 flex-wrap mt-3">
                <div class="form__input__single">
                    <label class="form__input__single__label">{{ __('Category') }}  <span class="required-star">*</span> </label>
            ...
            <div class="form__input__single mt-3">
                <label class="form__input__single__label">{{ __('Description') }} <span class="required-star">*</span></label>
        ...
        <div class="col-lg-4">
            ...
            <div class="col-lg-12 col-md-12 mt-4">
                <div class="form__input__single position-relative">
                    <label class="infoTitle">{{ __('Price') }} <span class="required-star">*</span></label>
            ...
            <div class="col-lg-12 col-md-12 mt-4">
                <div class="form__input__single position-relative">
                    <label class="infoTitle">{{ __('Discount Price') }} <span class="required-star">*</span></label>
                    <div class="input-form">
