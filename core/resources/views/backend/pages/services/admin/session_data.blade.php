@php
    ...
    <div class="session_service_car">
        @foreach ($all_cars as $key=>$car)
            <div class="card mt-2 mb-4 w-100 car-card {{$key>=5 ? 'd-none' : ''}}" data-index={{$key}} id="session_service_car_card">
                <div class="card-body">
                    <div class="row">
                        <!-- First Column -->
                        <div class="col-3">
                    ...
                    <div class="row">   
                        ...
                        <!-- <div class="col-3">    
                            <div class="form__input__single">
                                ...
                                <input type="text" class="form__control radius-5" name="car_unit1" id="unit1" value="{{ $car->unit ?? 0 }}" disabled>
                                <input type="hidden" class="form__control radius-5" name="car_unit[]" id="unit" value="{{ $car->unit ?? 0 }}">
                            </div>
                        </div> -->
                        <div class="col-3"> 
                            <div class="form__input__single">
   ...
   <div id="search_service_car_result">
    ...
    @if(count($all_cars)>5)
        <div class="text-center mt-3">
           <button type="button" class="btn btn-primary" id="loadMoreCars">{{ __('Load More') }}</button>
        </div>
    @endif