            ...
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="dashboard__card__header">
                    <div class="dashboard__card__header__flex">
                        <div class="dashboard__card__header__left">
                            <h5 class="dashboard__card__header__title">{{ __('Service Variant Info') }}</h5>
                        </div>
                    </div>
                </div>
                <div class="task_assignments__table custom_table mt-4">
                    <table>
                        ...
                        <tbody>
                        @foreach($service->serviceCar as $serviceCar)
                            <tr class="table_row">
                                <td>{{ $serviceCar?->varient?->id }}</td>
                                <td>
                                    ...
                                    <div class="table_customer">
                                        <div class="table_customer__flex">
                                            <div class="table_customer__contents">
                                                <h6 class="table_customer__title">{{ $serviceCar?->varient?->car->name}}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="table_customer">
                                        <div class="table_customer__flex">
                                            <div class="table_customer__contents">
                                                <h6 class="table_customer__title mt-1">{{ $serviceCar?->price }}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="table_customer">
                                        <div class="table_customer__flex">
                                            <div class="table_customer__contents">
                                                <h6 class="table_customer__title mt-1">{{ $serviceCar?->discount_price }}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="table_customer">
                                        <div class="table_customer__flex">
                                            <div class="table_customer__contents">
                                                <h6 class="table_customer__title mt-1">{{ $serviceCar?->varient?->engineType?->name }}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="table_customer">
                                        <div class="table_customer__flex">
                                            <div class="table_customer__contents">
                                                <h6 class="table_customer__title mt-1">{{ $serviceCar?->varient?->fualType?->name}}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </td>
            ...
            <div class="col-lg-12">
                <div class="dashboard__card bg__white padding-20 radius-10">
                    <div class="dashboard__card__header">
                        <div class="dashboard__card__header__flex">
                            <div class="dashboard__card__header__left">
                                <h5 class="dashboard__card__header__title">{{ __('Service Additional Info') }}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="task_assignments__table custom_table mt-4">
                        <table>
                            ...
                            <tbody>
                            @foreach($service->serviceAdditional as $info)
                                @if($info->type== "info")
                                    <tr class="table_row">
                                        <td>{{ $info->id }}</td>
                                        <td>
            ...
            <div class="col-lg-12">
                <div class="dashboard__card bg__white padding-20 radius-10">
                    <div class="dashboard__card__header">
                        <div class="dashboard__card__header__flex">
                            <div class="dashboard__card__header__left">
                                <h5 class="dashboard__card__header__title">{{ __('Service Additional Specification') }}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="task_assignments__table custom_table mt-4">
