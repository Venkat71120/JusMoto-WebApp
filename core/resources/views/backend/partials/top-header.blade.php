            ...
            <div class="header-action-item">
                <div class="profile-dropdown">
                    <a href="javascript:void(0)" class="profile-trigger">
                        <div class="profile-avatar">
                            @if(!empty(auth()->guard('admin')->user()->image))
                                {!! render_image_markup_by_attachment_id(auth()->guard('admin')->user()->image,'avatar') !!}
                            @else
                        ...
                        <div class="profile-info">
                            ...
                            <span class="profile-role">{{ __('Admin') }}</span>
                        </div>
                    ...
                    <div class="profile-menu">
                        ...
                        <a href="{{route('admin.profile.update')}}" class="profile-menu-item">
                            <i class="las la-user-edit"></i>
                            <span>{{ __('Edit Profile') }}</span>
                        </a>
                        <a href="{{route('admin.profile.password.change')}}" class="profile-menu-item">
                            <i class="las la-lock"></i>
                            <span>{{ __('Password Change') }}</span>
                        </a>
                        <div class="profile-divider"></div>
                        <a href="{{ route('admin.logout') }}" class="profile-menu-item logout">
...
(function($) {
    ...
    $(document).ready(function() {
        ...
        $('#mode_change').on('click', function() {
            ...
            // Update mode text
            if (newMode === 'on') {
                $(this).attr('title', '{{ __("Switch to Light Mode") }}');
            } else {
                $(this).attr('title', '{{ __("Switch to Dark Mode") }}');
            }
