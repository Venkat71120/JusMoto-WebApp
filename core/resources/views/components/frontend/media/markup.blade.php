        ...
        <div class="modal-content">
            <div class="modal-header justify-content-between">
                ...
                <div class="popup_contents__header__close">
                    <button type="button" class="popup_contents__close popup_close close border-0" aria-label="Close" data-bs-dismiss="modal">
            ...
            <div class="modal-footer">
                <button type="button"
                class="cmn-btn btn_primary media_upload_modal_submit_btn" style="display: none">{{__('Set Image')}}</button>
            </div>
        </div>
    </div>
</div>
