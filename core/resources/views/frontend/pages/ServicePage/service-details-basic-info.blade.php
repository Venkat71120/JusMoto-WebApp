        ...
        <div class="row">
            <div class="col-lg-7">
                        ...
                        <div class="sliderContains">
                            <div class="service-position" >
                                ...
                                <div class=" global-slick-init" data-slidestoshow="1" data-slidestoscroll="1"
                                    ...
                                    @else
                                        <div class="imgSlide">
                                            {!! render_image_markup_by_attachment_id($service->image, '', 'full') !!}
                                        </div>
                                    @endif
                                </div>
                                <span class="fvt-icon style2 icon-position favorite-btn {{ auth()->user()?->favoriteItems?->contains('item_id', $service->id) ? 'selected' : '' }}" data-id="{{ $service->id }}">
                        ...
                        <div class="mt-4">
                            <div class="product-thumbnail-wrapper">
                                <div class="product-thumbnail  d-flex gap-2">
                                    ...
                                    @endphp
                                    @if($gallery_count > 0)
                                        @for($i = 0; $i < min(4, $gallery_count); $i++)
                                            @php
                ...
                <div class="d-lg-none d-block mt-4 car-detalis">
                    <h1 class="product-title title-4 fw_semibold">{{$service->title}}</h1>
                    ...
                    <div class="category-row mt-60">
                        ...
                        <span class="category-value">{{$service->category->name}}</span>

                        <div class="quantity-cart-row">
                            <div class="add-btn-wraper">
                                <button type="button" class="cmn-btn primary-btn cart-btn" data-id="{{ $service->id }}" data-price="{{$new_price}}" {{ in_array($service->id, $cartItemIds) ? 'disabled' : '' }}>
