...
@section('page-meta-data')
    {!!  render_page_meta_data_for_service($service) !!}
@endsection
@section('content')
    <main>

        @include('frontend.pages.ServicePage.service-details-basic-info')
        @include('frontend.pages.ServicePage.related-service-section')
