        ...
        <div class="sidebar bg_light border_right">
            <div class="sidebar_list_wrapper">
                <ol class="sidebar_list pr_8 pl_0 pt_8">
                    <li>
                        <a href="{{ route('user.dashboard') }}" class="sidebar_list_item {{ request()->routeIs('user.dashboard') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('orders.index') }}" class="sidebar_list_item {{ request()->routeIs('orders.index') ? 'active' : '' }}">
                        <svg width="19" height="18" viewBox="0 0 19 18" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="{{ route('tickets.index') }}" class="sidebar_list_item {{ request()->routeIs('tickets.index') ? 'active' : '' }}">
                            <svg width="19" height="18" viewBox="0 0 19 18" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="{{ route('refunds.index') }}" class="sidebar_list_item {{ request()->routeIs('refunds.index') ? 'active' : '' }}">
                            <svg width="19" height="18" viewBox="0 0 19 18" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="{{ route('client.all.address') }}" class="sidebar_list_item {{ request()->routeIs('client.all.address') ? 'active' : '' }}">
                            <svg width="19" height="18" viewBox="0 0 19 18" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="{{ route('settings.index') }}" class="sidebar_list_item">
                    ...
                    <li>
                        <a href="{{ route('user.dashboard', ['openModal' => 'delete']) }}"
                ...
                <ol class="sidebar_list border_top pr_8 pl_0 pt_8 pb_8">
                    <li>
                        <a href="{{route('auth.logout')}}" class="sidebar_list_item">
                            <span class="sidebar_list_icon">
