...
Route::group(['prefix'=>'v1', 'middleware' => 'setlang'],function(){
    ...
    //Outlet Location
    Route::get('/all-outlet',[OutletLocationController::class,'outletList']);
    Route::get('/outlet-details/{id}',[OutletLocationController::class,'outletDetails']);
    ...
    Route::post('/service/review',[UserReviewController::class,'reviewListById']);
    ...
    Route::group(['prefix' => 'user/','middleware' => 'auth:sanctum'],function (){
        ...
        // user review
        Route::post('/review-add',[UserReviewController::class, 'reviewAdd']);
    ...
    Route::group(['prefix' => 'service/'],function (){
        ...
        Route::get('/details/{id}/{variant_id?}',[ServiceController::class,'serviceDetails'])->name('api.service.details');
        Route::get('schedule-lists/{day?}',[ServiceController::class,'scheduleByDay']);
   ...
   // Route::get('provider/order/invoice-details/{id?}', [InvoiceApiController::class, 'providerOrderInvoiceGenerate']);
    ...
    Route::get('/categories-with-products',[CategoryManageController::class,'categoriesWithProduct']);
    //all categories
