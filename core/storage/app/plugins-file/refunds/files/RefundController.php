...
class RefundController extends Controller
{
    ...
    public function refund(Request $request){
        $refunds = $this->refunds->paginate($request,get_yrsetting('paginate'),'');
    ...
    public function allApprovedRefund(Request $request){
        $refunds = $this->refunds->paginate($request,get_yrsetting('paginate'),'approved');
        return view('admin.refund.approved-refund',compact('refunds'));
    }

    public function allProcessedRefund(Request $request){
        $refunds = $this->refunds->paginate($request,get_yrsetting('paginate'),'processed');
        return view('admin.refund.processed-refund',compact('refunds'));
    }
    public function allRejectedRefund(Request $request){
        $refunds = $this->refunds->paginate($request,get_yrsetting('paginate'),'rejected');
        return view('admin.refund.rejected-refund',compact('refunds'));
    }
    public function refundSetting(){
        return view('admin.refund.refund-setting');
    }
