                    ...
                    $.ajax({
                        ...
                        error:function(data){
                            ...
                            }else if(errors.msg)
                            {
                                ...
                                erContainer.find('.alert.alert-danger').append('<p><?php echo e(__('Something went wrong, please try again later.')); ?></p>');
                            }
...
<?php echo $__env->make('layouts.login-screens', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/venkatesharavamudhan/Claude/JusMoto/main-files/Admin Panel/extracted/gocar-v1.1.0/core/resources/views/auth/admin/login.blade.php ENDPATH**/ ?>