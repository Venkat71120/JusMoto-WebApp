...
<style>
    * {
    ...
    #invoice-single-details-company
    {
        float:left;
    }
    #invoice-single-details-customer
    {
        float:right;
    }
        ...
        <div class="invoice-header">
            <div class="invoice-flex-contents">
                ...
                <div class="invoice-header-contents">
                    <h2 class="invoice-title"><?php echo e(get_static_option('invoice_title') ?? __('INVOICE')); ?></h2>
                </div>
            </div>
        </div>
        <div id="invoice_no">
            <span><strong><?php echo e(get_static_option('invoice_title') ?? __('Invoice No:')); ?></strong> <?php echo e($order_details->invoice_number); ?> </span>
        </div>
        <div class="invoice-details">
            <div>
                <?php echo $__env->make('backend.pages.orders.invoices.order-invoice-info', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
            <div class="item-description">
                <h6><?php echo e(__('Notes:')); ?></h6>
                <span><?php echo e(get_static_option('order_invoice_notes')); ?></span>
            </div>
        </div>
        <footer>
...
<?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/orders/invoices/orders-invoice.blade.php ENDPATH**/ ?>