            ...
            <div class="popup_contents__header">
                <div class="popup_contents__header__flex">
                    <div class="popup_contents__header__contents">
                        <h2 class="popup_contents__header__title"><?php echo e(__('twilio')); ?></h2>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\Modules/SMSGateway\resources/views/backend/modal/twilio_modal.blade.php ENDPATH**/ ?>