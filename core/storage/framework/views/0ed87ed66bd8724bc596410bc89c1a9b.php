            ...
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="header-wrap d-flex justify-content-between mb-4">
                    <div class="left-content">
                        <h4 class="header-title"><?php echo e(__('Edit Fuel Details')); ?>   </h4>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="add-listing-wrapper mt-4">
                                ...
                                <form action="<?php echo e(route('admin.fual.edit', $fual->id)); ?>" method="post" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div  class="add-listing-content-wrapper mt-4">
                                        <div class="tab-content add-listing-content" id="add-listing-tabContent">
                                            <!-- car Info start-->
                                           <?php echo $__env->make('backend.pages.admin.fual.edit-fual-details', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                                            <!-- car Info end-->
                                            <div  class="col-lg-12 mt-5">
                                                <div class="btn_wrapper gap-3">
                                                    <button class="cmnBtn btn_5 btn_bg_blue radius-5" id="submitBtn" type="submit"><?php echo e(__('Edit Fuel')); ?></button>
                                                </div>
                                            </div>
...
<?php echo $__env->make('backend.admin-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/admin/fual/edit-fual.blade.php ENDPATH**/ ?>