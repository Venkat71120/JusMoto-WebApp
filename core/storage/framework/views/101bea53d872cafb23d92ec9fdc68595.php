                    ...
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title">
                                ...
                                <?php echo e(__('Order Cancellation Policy')); ?>

                            </h4>
                            <div class="policy-badge">
                                <span class="status-badge active">
                                    <i class="las la-shield-alt"></i>
                                    <?php echo e(__('Active Policy')); ?>
...
<?php endif; ?>
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <form action="<?php echo e(route('admin.order.cancellation-policy')); ?>" method="POST" id="cancellationPolicyForm">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form__input__single">
                                    <label class="form__input__single__label">
                                        ...
                                        <?php echo e(__('Fine Type')); ?>

                                        <span class="text-danger">*</span>
                                    </label>
                                    <select id="fine_type" name="fine_type" class="form-control">
                                        <option <?php echo e($cancellationPolicy?->fine_type == 'flat' ? 'selected' : ''); ?> value="flat">
                                            <?php echo e(__('Flat Amount')); ?>

                                        </option>
                                        <option <?php echo e($cancellationPolicy?->fine_type == 'percentage' ? 'selected' : ''); ?> value="percentage">
                                    ...
                                    <div class="form-info">
                                        ...
                                        <?php echo e(__('Select how the fine should be calculated')); ?>
                                ...
                                <div class="form__input__single">
                                    ...
                                    <div class="input-with-icon">
                                        <input type="number" 
                                               ...
                                               name="amount" 
                                               id="amount" 
                                               value="<?php echo e($cancellationPolicy?->amount); ?>"
                                               placeholder="<?php echo e(__('Enter amount')); ?>" 
                                               step="0.01"
                                               min="0">
                                        <span class="input-symbol" id="amountSymbol">
                                            <?php echo e($cancellationPolicy?->fine_type == 'percentage' ? '%' : '$'); ?>

                                        </span>
                                    </div>
                                    <div class="form-info">
                                        <i class="las la-calculator"></i>
                                        <?php echo e(__('Enter the fine amount or percentage')); ?>
                                ...
                                <div class="form__input__single">
                                    <label class="form__input__single__label">
                                        ...
                                        <?php echo e(__('Availability Type')); ?>

                                        <span class="text-danger">*</span>
                                    </label>
                                    <select id="available_type" name="available_type" class="form-control">
                                        <option <?php echo e($cancellationPolicy?->available_type == 'always' ? 'selected' : ''); ?> value="always">
                                            <?php echo e(__('Always Available')); ?>

                                        </option>
                                        <option <?php echo e($cancellationPolicy?->available_type == 'certain_time' ? 'selected' : ''); ?> value="certain_time">
                                            <?php echo e(__('Certain Time Period')); ?>

                                        </option>
                                    </select>
                                    <div class="form-info">
                                        <i class="las la-calendar-alt"></i>
                                        <?php echo e(__('Choose when this policy applies')); ?>

                                    </div>
                                </div>

                                <!-- Time Input (Conditional) -->
                                <div class="form__input__single <?php echo e($cancellationPolicy?->available_type == 'certain_time' ? '' : 'd-none'); ?>" 
                                     id="div_time_in_min">
                                    <label class="form__input__single__label">
                                        <i class="las la-hourglass-half" style="color: var(--red); margin-right: 6px;"></i>
                                        <?php echo e(__('Time (in minutes)')); ?>
                                    ...
                                    <input type="number" 
                                           ...
                                           name="time_in_min" 
                                           id="time_in_min" 
                                           value="<?php echo e($cancellationPolicy?->time_in_min); ?>"
                                           placeholder="<?php echo e(__('Enter time in minutes')); ?>" 
                                           step="1"
                                           min="0">
                                    <div class="form-info">
                                        <i class="las la-clock"></i>
                                        <?php echo e(__('Cancellation allowed within this time period')); ?>
                                ...
                                <div class="form__input__single mt-3">
                                    <label class="form__input__single__label">
                                        ...
                                        <?php echo e(__('Policy Description')); ?>

                                    </label>
                                    <div class="input-form input-form2">
                                        <textarea class="textarea--form" 
                                                  name="description" 
                                                  placeholder="<?php echo e(__('Describe the cancellation policy details...')); ?>" 
                                                  rows="6"><?php echo e($cancellationPolicy?->description); ?></textarea>
                                    </div>
                                    <div class="form-info">
                                        <i class="las la-file-alt"></i>
                                        <?php echo e(__('Provide detailed information about the cancellation policy')); ?>
                                ...
                                <div class="btn_wrapper mt-4">
                                    <button type="submit" id="update" class="cmnBtn btn_5 btn_bg_blue radius-5 update_info">
                                        ...
                                        <?php echo e(__('Update Cancellation Policy')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/orders/order_cancellation_policy/add.blade.php ENDPATH**/ ?>