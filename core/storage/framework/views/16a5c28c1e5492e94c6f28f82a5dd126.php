...
<div class="tab-pane fade step" id="car" role="tabpanel" aria-labelledby="select-car-tab">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">    
                                <div class="form__input__single">
                                    <label for="car_brand_id" class="form__input__single__label"><?php echo e(__('Brand')); ?>  <span class="text-danger">*</span> </label>
    ...
    <div id="session_data">
        <?php echo $__env->make("backend.pages.products.admin.session_data", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
    <div class="btn_wrapper d-flex justify-content-end gap-3 mt-4">
        ...
        <button type="submit" class="cmnBtn btn_5 btn_bg_blue radius-5 validate_subscription_type"><?php echo e(__('Add Product')); ?></button>
    </div>
...
<?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/products/admin/select-product-car.blade.php ENDPATH**/ ?>