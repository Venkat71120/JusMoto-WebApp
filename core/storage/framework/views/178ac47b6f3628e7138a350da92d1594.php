...
<div class="form-group <?php echo e($class); ?>">
    <label for="<?php echo e($name); ?>" class="form__input__single__label"><?php echo e(__($title)); ?></label>
    ...
    <?php if(isset($dimentions) && !empty($dimentions)): ?>
        <small><?php echo e(__('recommended image size is')); ?> <?php echo e($dimentions ?? ''); ?></small>
    <?php endif; ?>
</div>
<?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/components/image/image.blade.php ENDPATH**/ ?>