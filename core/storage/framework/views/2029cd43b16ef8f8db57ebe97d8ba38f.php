                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    <label class="form-label"><?php echo e(__('Brand')); ?> <span class="required">*</span></label>
                                ...
                                <!-- Price -->
                                <div class="form-group">
                                    <label class="form-label"><?php echo e(__('Price')); ?> <span class="required">*</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="duration1[]" id="duration1" placeholder="<?php echo e(__('e.g. 2 hours, 30 minutes')); ?>">
                                </div>
