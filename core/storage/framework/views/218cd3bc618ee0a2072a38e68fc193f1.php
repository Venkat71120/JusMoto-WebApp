    ...
    <div class="row">
        <div class="col-12">
                    ...
                    <?php $__currentLoopData = $service->includes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $include): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="single-dashboard-input what-include-element">
                            <div class="single-info-input margin-top-20">
                                ...
                                <input class="form-control" type="text" name="include_service_title[]" value="<?php echo e($include->title); ?>" placeholder="<?php echo e(__('Service title')); ?>">
                            </div>
            ...
            <div class="single-settings margin-top-40">
                <h5 class="input-title"> <?php echo e(__('Add Services Additional Info')); ?> </h5>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="d-flex g-2">
                                            ...
                                            <div class="single-info-input margin-top-20 me-2">
                                                <label><?php echo e(__('Title')); ?></label>
                                                <input class="form-control" type="text" name="service_info_title[]" value="<?php echo e($additional->title); ?>">
                                            </div>
                ...
                <div class="btn-wrapper margin-top-20">
                    <a href="javascript:void(0)" class="cmnBtn btn_5 btn_bg_blue radius-5 add-services-info"> <?php echo e(__('Add More')); ?> </a>
                </div>
            </div>

            <div class="single-settings margin-top-40">
                <h5 class="input-title"> <?php echo e(__('Add Services Specification')); ?> </h5>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="d-flex g-2">
                                            <div class="single-info-input margin-top-20 me-2">
                                                <label><?php echo e(__('Title')); ?></label>
                                                <input class="form-control" type="text" name="service_specification_title[]" value="<?php echo e($additional->title); ?>">
                                            </div>
                ...
                <div class="btn-wrapper margin-top-20">
                    <a href="javascript:void(0)" class="cmnBtn btn_5 btn_bg_blue radius-5 add-services-specification"> <?php echo e(__('Add More')); ?> </a>
                </div>
            </div>
