        ...
        <div class="col-12">
            ...
            <div class="settings-card">
                <div class="settings-header">
                    ...
                    <h5 class="settings-title"><?php echo e(__('What\'s Included In This Package')); ?></h5>
                </div>
                ...
                <div class="settings-body">
                                ...
                                <div class="include-item-content">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="include_service_title[]" 
                                               value="<?php echo e($include->title); ?>" placeholder="<?php echo e(__('e.g. Free Car Wash, Oil Change')); ?>">
                                    </div>
                                    <button type="button" class="remove-item remove-include" title="<?php echo e(__('Remove')); ?>">
                    ...
                    <div class="add-more-wrapper">
                        <a href="javascript:void(0)" class="add-more-btn add-what-includes">
                            ...
                            <?php echo e(__('Add Another Item')); ?>
            ...
            <div class="settings-card">
                <div class="settings-header">
                    ...
                    <h5 class="settings-title"><?php echo e(__('Frequently Asked Questions')); ?></h5>
                </div>
                        ...
                        <?php $__currentLoopData = $service->faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="faq-item">
                                <div class="faq-item-content">
                                    <div class="form-group">
                                        <label class="form-label"><?php echo e(__('Question')); ?></label>
                                        <input class="form-control" type="text" name="faqs_title[]" 
                                               value="<?php echo e($faq->title); ?>" placeholder="<?php echo e(__('e.g. How long does the service take?')); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label"><?php echo e(__('Answer')); ?></label>
                                        <textarea class="form-control" name="faqs_description[]" rows="3" 
                                                  placeholder="<?php echo e(__('Provide a detailed answer...')); ?>"><?php echo e($faq->description); ?></textarea>
                                    </div>
                                    <button type="button" class="remove-item remove-faqs" title="<?php echo e(__('Remove')); ?>">
                                        <i class="las la-trash"></i>
                                    </button>
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="settings-card h-100">
                        <div class="settings-header">
                            ...
                            <h5 class="settings-title"><?php echo e(__('Additional Information')); ?></h5>
                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-with-remove">
                                                        <input class="form-control" type="text" name="service_info_title[]" 
                                                               value="<?php echo e($additional->title); ?>" placeholder="<?php echo e(__('e.g. Warranty Information')); ?>">
                                                        <button type="button" class="remove-item remove-info" title="<?php echo e(__('Remove')); ?>">
                                                            <i class="las la-trash"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="media-upload-card">
                                                        <div class="image-preview">
                                                            <?php echo render_image_markup_by_attachment_id($additional->image, 'thumb', 'preview-img'); ?>

                                                            <?php if(empty($additional->image)): ?>
                ...
                <div class="col-md-6">
                    <div class="settings-card h-100">
                        <div class="settings-header">
                            ...
                            <h5 class="settings-title"><?php echo e(__('Service Specifications')); ?></h5>
                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-with-remove">
                                                        <input class="form-control" type="text" name="service_specification_title[]" 
                                                               value="<?php echo e($additional->title); ?>" placeholder="<?php echo e(__('e.g. Engine Type, Fuel Efficiency')); ?>">
                                                        <button type="button" class="remove-item remove-specification" title="<?php echo e(__('Remove')); ?>">
                                                            <i class="las la-trash"></i>
                                                        </button>
                                                    </div>
                                                </div>
...
</style><?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/services/admin/edit-service-include.blade.php ENDPATH**/ ?>