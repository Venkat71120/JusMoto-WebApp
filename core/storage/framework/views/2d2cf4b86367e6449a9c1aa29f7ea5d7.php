<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Service Create Page Settings')); ?>
    ...
    <div class="row g-4 mt-0">
        <div class="col-xl-6 col-lg-6">
            <div class="dashboard__card bg__white padding-20 radius-10">
                <h2 class="dashboard__card__header__title mb-3"><?php echo e(__('Service Create Page Settings')); ?></h2>
...
<?php endif; ?>
                <form action="<?php echo e(route('admin.service.create.settings')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="form__input__single">
                        <label class="form__input__single__label"><?php echo e(__('Who Will Create Service?')); ?></label>
                        <select name="service_create_settings" id="service_create_settings"  class="form-control">
                            <option value="" disabled><?php echo e(__('Select')); ?></option>
                                <option value="all_user" <?php echo e(get_static_option('service_create_settings')=='all_user' ? 'selected' : ''); ?> ><?php echo e(__('All User')); ?></option>
                                <option value="verified_user" <?php echo e(get_static_option('service_create_settings')=='verified_user' ? 'selected' : ''); ?> ><?php echo e(__('Only Verified User')); ?></option>
                        </select>
                    </div>

                    <div class="form__input__single">
                        <label class="form__input__single__label"><?php echo e(__('Select Status')); ?></label>
                        ...
                        <p class="mb-3 text-info"><?php echo e(__('You can set the user create service status auto Approved/Pending from here.')); ?></p>
                    </div>
...
<?php echo $__env->make('backend.admin-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/page-settings/service-create-page-settings.blade.php ENDPATH**/ ?>