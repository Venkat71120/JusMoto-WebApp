        ...
        <div class="table_customer__flex">
            <div class="table_customer__contents">
                ...
                <h6 class="table_customer__title">
                    <?php echo e(__('Name:')); ?> <?php echo e($data->user?->first_name); ?>

                </h6>

                <h6 class="table_customer__title">
                    <?php echo e(__('Email:')); ?> <?php echo e($data->user?->email); ?>
                    ...
                    <td>
                        <div class="table_customer">
                            <div class="table_customer__flex">
                                <div class="table_customer__contents">
                                    <h6 class="table_customer__title"><?php echo e(__('Sub Total:')); ?>

                                        <?php echo e(float_amount_with_currency_symbol($data->sub_total)); ?> </h6>
                                    <?php if($data->coupon_amount > 0): ?>
                                        <h6 class="table_customer__title"> <?php echo e(__('Coupon Amount:')); ?> <strong>-</strong>
                                            <?php echo e(float_amount_with_currency_symbol($data->coupon_amount)); ?> </h6>
                                    <?php endif; ?>
                                    <h6 class="table_customer__title"><?php echo e(__('Tax:')); ?> <strong>+</strong>
                                        <?php echo e(float_amount_with_currency_symbol($data->tax)); ?></h6>
                                    <h6 class="table_customer__title"><?php echo e(__('Total:')); ?>

                                        <?php echo e(float_amount_with_currency_symbol($data->total)); ?></h6>
                                </div>
                            </div>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="table_customer">
                            <div class="table_customer__flex">
                                <div class="table_customer__contents">
                                    <h6 class="table_customer__title"><?php echo e(__('Gateway:')); ?> <?php echo e($data->payment_gateway); ?>
...
<?php endif; ?></span>
                            <span>
                                ...
                                btnIcon radius-5 order_status_change_modal" data-order_id="<?php echo e($data->id); ?>"
...
</div><?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/orders/admin-orders/search-order.blade.php ENDPATH**/ ?>