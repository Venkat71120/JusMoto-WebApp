        ...
        <div class="popup_contents modal-content">
            <div class="popup_contents__header">
                <div class="popup_contents__header__flex">
                    <div class="popup_contents__header__contents">
                        <h2 class="popup_contents__header__title"><?php echo e(__('Nexmo')); ?></h2>
                    </div>
            ...
            <form action="<?php echo e(route('admin.sms.gateway.update')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="popup_contents__body">
                    <!--otp env settings -->
                    <h5 class="mb-4"><?php echo e(__('Configure Nexmo credentials')); ?></h5>
                    <div class="form-group mt-3">
                        <label for="nexmo_api_key"><strong><?php echo e(__('API key')); ?> <span class="text-danger">*</span> </strong></label>
                        <input type="text"  class="form-control" name="nexmo_api_key" value="" placeholder="<?php echo e(__('Nexmo Api Key')); ?>">
                    </div>

                    <div class="form-group">
                        <label for="nexmo_api_secret"><strong><?php echo e(__('API Secret')); ?> <span class="text-danger">*</span></strong></label>
                        <input type="text"  class="form-control" name="nexmo_api_secret" value="" placeholder="<?php echo e(__('API Secret')); ?>">
                    </div>
...
<?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\Modules/SMSGateway\resources/views/backend/modal/nexmo_modal.blade.php ENDPATH**/ ?>