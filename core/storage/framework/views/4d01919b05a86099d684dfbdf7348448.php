...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fields.switcher','data' => ['value' => ''.e(get_static_option('cash_on_delivery')).'','name' => 'cash_on_delivery','label' => ''.e(__('Enable Cash On Delivery')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.media.edit-media-upload-image','data' => ['label' => ''.e(__(ucfirst($gateway->name).' '.'Logo')).'','name' => ''.e($gateway->name.'_logo').'','value' => $gateway->image]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if($gateway->name == 'paytabs'): ?>
                                        <?php if($cre_name == 'region'): ?>
                                            <small class="text-secondary fs-12">GLOBAL,
                                                ARE, EGY, SAU,
                                                OMN, JOR</small>
                                        <?php endif; ?>
                                    <?php endif; ?>
...
<?php echo $__env->make('backend.admin-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\Modules/PaymentGateways\resources/views/backend/payment_settings.blade.php ENDPATH**/ ?>