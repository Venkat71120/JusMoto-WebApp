<?php
    ...
    <div class="session_service_car">
        <?php $__currentLoopData = $all_cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card mt-2 mb-4 w-100 car-card <?php echo e($key>=5 ? 'd-none' : ''); ?>" data-index=<?php echo e($key); ?> id="session_service_car_card">
                <div class="card-body">
                    <div class="row">
                        <!-- First Column -->
                        <div class="col-3">
                    ...
                    <div class="row">   
                        ...
                        <!-- <div class="col-3">    
                            <div class="form__input__single">
                                ...
                                <input type="text" class="form__control radius-5" name="car_unit1" id="unit1" value="<?php echo e($car->unit ?? 0); ?>" disabled>
                                <input type="hidden" class="form__control radius-5" name="car_unit[]" id="unit" value="<?php echo e($car->unit ?? 0); ?>">
                            </div>
                        </div> -->
                        <div class="col-3"> 
                            <div class="form__input__single">
   ...
   <div id="search_service_car_result">
    ...
    <?php endif; ?><?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/services/admin/session_data.blade.php ENDPATH**/ ?>