                    ...
                    <div class="tab-pane fade show active" id="blog_meta" role="tabpanel" aria-labelledby="nav-21-tab">
                        <div class="form__input__flex mt-3">
                            <div class="form__input__single">
                                ...
                                <input type="text" class="form__control" name="meta_title" id="meta_title" placeholder="<?php echo e(__('Title')); ?>">
                            </div>
                            <div class="form__input__single">
                                <label for="meta_tags" class="form__input__single__label"><?php echo e(__('Meta Tags')); ?></label>
                                <input type="text" class="form__control" name="meta_tags" id="meta_tags" data-role="tagsinput" placeholder="<?php echo e(__('Tag')); ?>">
                            </div>
                            <div class="form__input__single">
...
<?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/components/backend/page-meta-data-create.blade.php ENDPATH**/ ?>