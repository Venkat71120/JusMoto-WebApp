    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="form__input__single">
                ...
                <input type="text" class="form__control radius-5"  name="title" id="title" value="<?php echo e($service->title); ?>" placeholder="<?php echo e(__('Add title')); ?>">
            </div>
            ...
            <div class="form__input__single mt-3">
                <div class="input-form input-form2 permalink_label">
                    ...
                    <input class="listing_slug form__control radius-5" name="slug" value="<?php echo e($service->slug); ?>" id="slug" type="text">
            ...
            <div class="form__input__single mt-4">
                ...
                <div class="input-form input-form2">
                    <textarea class="textarea--form" name="description" placeholder="<?php echo e(__('Type Description')); ?>" rows="8" cols="8"><?php echo e($service->description); ?></textarea>
                </div>
            </div>
            ...
            <div class="d-flex">
                ...
                <div class="form__input__single">
                    ...
                    <div class="input-form input-form2">
                        <input type="text" class="form__control radius-5" name="video_url" id="video_url" value="<?php echo e($service->video_url); ?>" placeholder="<?php echo e(__('youtube url')); ?>">
                    </div>
                ...
                <div class="form__input__single mt-4 mx-3">
                    <div class="checkBox">
                        <label class="is_featured form__input__single__label d-flex gap-2">
                            <input class="checkBox__input effectBorder" type="checkbox" name="is_featured" id="is_featured" value="<?php echo e($service->is_featured); ?>" <?php if($service->is_featured == 1): ?> checked <?php endif; ?>>
        ...
        <div class="col-lg-4">
            ...
            <div class="col-lg-12 col-md-12 mt-5">
                <div class="form__input__single position-relative">
                    ...
                    <div class="input-form input-form2">
                        <input type="number" class="form__control radius-5" name="price" id="price" value="<?php echo e($service->price); ?>" placeholder="<?php echo e(__('0.00')); ?>" step="0.01">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12 mt-4">
                <div class="form__input__single position-relative">
                    ...
                    <div class="input-form input-form2">
                        <input type="number" class="form__control radius-5" name="discount_price" id="discount_price" value="<?php echo e($service->discount_price); ?>" placeholder="<?php echo e(__('0.00')); ?>" step="0.01">
                    </div>
                </div>
            </div>
             ...
             <div class="col-lg-12 col-md-12 mt-4">
                <div class="form__input__single position-relative">
                    ...
                    <div class="input-form input-form2">
                        <input type="text" class="form__control radius-5" name="duration" id="duration" value="<?php echo e($service->duration); ?>" placeholder="<?php echo e(__('e.g.hour,miute,second')); ?>">
                    </div>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 mt-4">
                <div class="form__input__single position-relative">
                    ...
                    <div class="input-form input-form2">
                        <input type="text" class="form__control radius-5" name="max_qty" id="max_qty" value="<?php echo e($service->max_qty); ?>" placeholder="<?php echo e(__('Enter Max Quantity')); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12 mt-3">
                <div class="upload-img">
                    <div class="media-upload-btn-wrapper">
                        ...
                        <input type="hidden" name="gallery_images" value="<?php echo e($service->gallery_images); ?>">
                        <button type="button" class="btn btn-info media_upload_form_btn"
                                data-btntitle="<?php echo e(__('Select Image')); ?>"
                                data-modaltitle="<?php echo e(__('Upload Image')); ?>"
                                data-mulitple="true"
...
<?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/services/admin/edit-service-details.blade.php ENDPATH**/ ?>