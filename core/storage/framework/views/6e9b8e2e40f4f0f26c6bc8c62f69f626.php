...
<div class="session_product_car">
    <?php $__currentLoopData = $all_cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card mt-2 mb-4 w-100 car-card <?php echo e($key >=5 ? 'd-none' : ''); ?>" data-index="<?php echo e($key); ?>"id="session_product_car_card">
            <div class="card-body">
                <div class="row">
                    <!-- First Column -->
                    <div class="col-3">
...
<?php if(count($all_cars)>5): ?>
   <div class="text-center mt-3">
           <button type="button" class="btn btn-primary" id="loadMoreCarsForProduct"><?php echo e(__('Load More')); ?></button>
    </div>
<?php endif; ?>



    <?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/products/admin/session_data.blade.php ENDPATH**/ ?>