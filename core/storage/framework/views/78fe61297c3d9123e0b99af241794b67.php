    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            function countries(page){
                $.ajax({
                    url:"<?php echo e(route('admin.staff.paginate.data').'?page='); ?>" + page,
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.staff.search')); ?>",
                    method:'GET',
...
<?php /**PATH /Users/venkatesharavamudhan/Claude/JusMoto/main-files/Admin Panel/extracted/gocar-v1.1.0/core/resources/views/backend/pages/staffs/staff-js.blade.php ENDPATH**/ ?>