            ...
            <div class="dashboard_order__tab d-flex flex-wrap gap-3">
                <ul class="tabs">
                    ...
                    <li class="<?php echo e($current_status === '2' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('admin.service.all.orders', ['status' => '2'])); ?>"><?php echo e(__('Completed')); ?> <span class="badge_notification"><?php echo e($total_completed_order); ?></span></a>
                    </li>
                </ul>
            </div>
        </div>
...
<?php /**PATH /Users/venkatesharavamudhan/Claude/JusMoto/main-files/Admin Panel/extracted/gocar-v1.1.0/core/resources/views/backend/pages/orders/order-filter.blade.php ENDPATH**/ ?>