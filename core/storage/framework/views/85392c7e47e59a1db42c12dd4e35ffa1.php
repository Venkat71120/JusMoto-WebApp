    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            function countries(page){
                $.ajax({
                    url:"<?php echo e(route('admin.schedule.paginate.data').'?page='); ?>" + page,
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.schedule.search')); ?>",
                    method:'GET',
...
<?php /**PATH /Users/venkatesharavamudhan/Claude/JusMoto/main-files/Admin Panel/extracted/gocar-v1.1.0/core/resources/views/backend/pages/schedules/schedules-js.blade.php ENDPATH**/ ?>