            ...
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="header-wrap d-flex justify-content-between mb-4">
                    ...
                    <div class="right-content">
                        <a class="cmnBtn btn_5 btn_bg_info radius-5" href="<?php echo e(route('admin.brand.all')); ?>"><?php echo e(__('All Brands')); ?></a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="add-listing-wrapper mt-4">
                                ...
                                <form action="<?php echo e(route('admin.brand.edit', $brand->id)); ?>" method="post" enctype="multipart/form-data" id="brandEditForm">
                                    <?php echo csrf_field(); ?>
                                    <div  class="add-listing-content-wrapper mt-4">
                                        <div class="tab-content add-listing-content" id="add-listing-tabContent">
                                            <!-- brand Info start-->
                                           <?php echo $__env->make('backend.pages.admin.brand.edit-brand-details', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            <!-- brand Info end-->
                                            <div  class="col-lg-12 mt-5">
                                                <div class="btn_wrapper gap-3">
                                                    <button class="cmnBtn btn_5 btn_bg_blue radius-5" id="submitBtn" type="submit"><?php echo e(__('Update Brand')); ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('backend.admin-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/admin/brand/edit_brand.blade.php ENDPATH**/ ?>