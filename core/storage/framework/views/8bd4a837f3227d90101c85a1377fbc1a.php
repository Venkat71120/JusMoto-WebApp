<div class="modal fade" tabindex="-1" id="msg91_modal">
    <div class="modal-dialog">
        <div class="popup_contents modal-content">
            <div class="popup_contents__header">
                <div class="popup_contents__header__flex">
                    <div class="popup_contents__header__contents">
                        <h2 class="popup_contents__header__title"><?php echo e(__('MSG91')); ?></h2>
                    </div>
            ...
            <form action="<?php echo e(route('admin.sms.gateway.update')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>

                <input type="hidden" name="sms_gateway_name" value="msg91">
                <div class="popup_contents__body">
                    <!--otp env settings -->
                    <h5 class="mb-4"><?php echo e(__('Configure MSG91 credentials')); ?></h5>
                    <div class="form__input__single">
                        <label for="MSG91_AUTH_TOKEN"><strong><?php echo e(__('MSG91 Auth Key')); ?> <span class="text-danger">*</span></strong></label>
                        <input type="text"  class="form-control" name="msg91_auth_key" value=""
                               placeholder="<?php echo e(__('MSG91 Auth Key')); ?>">
                    </div>

                    <div class="form__input__single">
                        <label for="MSG91_OTP_TEMPLATE_ID"><strong><?php echo e(__('OTP Template ID')); ?> <span class="text-danger">*</span> </strong></label>
                        <input type="text" class="form-control" name="msg91_otp_template_id" value=""
                               placeholder="<?php echo e(__('OTP Template ID')); ?>">
                    </div>

                    <div class="form__input__single">
                        <label for="MSG91_NOTIFY_TEMPLATE_ID"><strong><?php echo e(__('Notify User Register Template ID')); ?> <span class="text-danger">*</span> </strong></label>
                        <input type="text" class="form-control" name="msg91_notify_user_register_template_id" value=""
                               placeholder="<?php echo e(__('Notify User Register Template ID')); ?>">
                    </div>
...
<?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\Modules/SMSGateway\resources/views/backend/modal/msg91_modal.blade.php ENDPATH**/ ?>