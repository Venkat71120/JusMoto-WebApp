...
<?php endif; ?>
                    ...
                    <td>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-product-published-status-change')): ?>
                        <span class="my-2">
                            <?php if (isset($component)) { $__componentOriginalf90726ca044d81a36c244f8ae94f2537 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf90726ca044d81a36c244f8ae94f2537 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status.admin-products-published-change','data' => ['url' => route('admin.product.published.status.change',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('status.admin-products-published-change'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.product.published.status.change',$data->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf90726ca044d81a36c244f8ae94f2537)): ?>
<?php $attributes = $__attributesOriginalf90726ca044d81a36c244f8ae94f2537; ?>
<?php unset($__attributesOriginalf90726ca044d81a36c244f8ae94f2537); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf90726ca044d81a36c244f8ae94f2537)): ?>
<?php $component = $__componentOriginalf90726ca044d81a36c244f8ae94f2537; ?>
<?php unset($__componentOriginalf90726ca044d81a36c244f8ae94f2537); ?>
<?php endif; ?>
                        </span>
                        <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status.status-change','data' => ['url' => route('admin.product.status.change',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.product.status.change',$data->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <?php else: ?>
             <tr>
                <td colspan="11" class="text-center"><?php echo e(__('No data found')); ?></td>
            </tr>
        <?php endif; ?>       
    </tbody>
</table>
...
<?php /**PATH /Users/venkatesharavamudhan/Claude/JusMoto/main-files/Admin Panel/extracted/gocar-v1.1.0/core/resources/views/backend/pages/products/admin/search-product.blade.php ENDPATH**/ ?>