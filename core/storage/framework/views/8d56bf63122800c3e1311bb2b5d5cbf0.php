                ...
                <div class="dashboard__inner__header">
                    <div class="dashboard__inner__header__flex">
                        <div class="dashboard__inner__header__left">
                            <h4 class="dashboard__inner__header__title"><?php echo e(__('All Brand')); ?></h4>
...
<?php endif; ?>
                        ...
                        <div class="dashboard__inner__header__right">
                            <div class="btn-wrapper">
                                <a href="<?php echo e(route('admin.brand.add')); ?>" class="cmnBtn btn_5 btn_bg_blue radius-5"><?php echo e(__('Add Brand')); ?></a>
                            </div>
