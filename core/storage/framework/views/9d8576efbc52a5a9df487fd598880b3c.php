                    ...
                    <div class="nav-top-wrapper d-lg-none">
                        ...
                        <div class="navbar-right-item">
                            <div class="cart-logo openCartBtn">
                                <i class="fas fa-cart-shopping black-text"></i>
                                <?php
                                    if(auth()->check()) {
...
<?php /**PATH /Users/venkatesharavamudhan/Claude/JusMoto/main-files/Admin Panel/extracted/gocar-v1.1.0/core/resources/views/frontend/layout/partials/navbar-other.blade.php ENDPATH**/ ?>