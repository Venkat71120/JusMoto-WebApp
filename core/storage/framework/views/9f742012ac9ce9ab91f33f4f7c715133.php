                ...
                <div class="dashboard__inner__header">
                    <div class="dashboard__inner__header__flex">
                        <div class="dashboard__inner__header__left">
                            <h4 class="dashboard__inner__header__title"><?php echo e(__('All Categories')); ?></h4>
...
<?php endif; ?>
                        ...
                        <div class="dashboard__inner__header__right">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('category-add')): ?>
                                <a href="<?php echo e(route('admin.category.new')); ?>" class="cmnBtn btn_5 btn_bg_blue radius-5"><?php echo e(__('Add Category')); ?></a>
                            <?php endif; ?>
                            <div class="btn-wrapper mt-3">
                                <input class="form__control category_string_search" name="string_search" id="string_search" placeholder="<?php echo e(__('Search')); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tableStyle_three mt-4">
                    <div class="table_wrapper custom_Table">
                        <div class="search_category_result">
                            <?php echo $__env->make('backend.pages.category.search-category', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action.bulk-action-js','data' => ['url' => route('admin.category.bulk.action')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
        ...
        (function(){
            ...
            $(document).ready(function(){
                    ...
                    $.ajax({
                        ...
                        success:function(res){
                            if(res.status=='nothing'){
                                $('.search_category_result').html('<h3 class="text-center text-danger">'+"<?php echo e(__('Nothing Found')); ?>"+'</h3>');
                            }else{
                ...
                function notices(page,string_search){
                    $.ajax({
                        url:"<?php echo e(route('admin.category.paginate').'?page='); ?>" + page,
                        data:{string_search:string_search},
                        success:function(res){
                            $('.search_category_result').html(res);
                        }
...
<?php echo $__env->make('backend.admin-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/category/index.blade.php ENDPATH**/ ?>