<script>
    $(document).ready(function () {
     ...
     let ctxProductListings = document.getElementById('lineChartProductListings').getContext('2d');
     ...
     function createChartProducts(data) {
      ...
      lineChartProductListings = new Chart(ctxProductListings, {
       type: 'line',
       data: {
        labels: data.labels,
        datasets: [{
...
<?php /**PATH /Users/venkatesharavamudhan/Claude/JusMoto/main-files/Admin Panel/extracted/gocar-v1.1.0/core/resources/views/backend/pages/dashboard/line-graph-js.blade.php ENDPATH**/ ?>