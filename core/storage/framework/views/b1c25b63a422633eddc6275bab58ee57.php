                ...
                <div class="dashboard__inner__header mb-3">
                    <div class="dashboard__inner__header__flex">
                        <div class="dashboard__inner__header__left">
                            <h4 class="dashboard__inner__header__title"><?php echo e($role->name); ?>: <?php echo e(__("Permissions")); ?></h4>
                        </div>
                        <div class="dashboard__inner__header__right">
                            <a class="cmnBtn btn_5 btn_bg_info radius-5" href="<?php echo e(route('admin.role.create')); ?>"> <?php echo e(__('All Roles')); ?></a>
                        </div>
                    </div>
                </div>
            <div class="permission-wrap">
                <form action="<?php echo e(route("admin.role.permission.create",$role->id)); ?>" method="post">
                    <?php echo csrf_field(); ?>

                    <div class="checkbox-wrapper">
                        <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $permission_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="permission-group-wrapper">
                                <div class="permission-group-header">
                                    <h5 class="permission-group-header-title mt-4 mb-3">
                                        <?php echo e(ucwords($groupName)); ?>


                                        <div class="vendor-coupon-switch mt-3">
                                            <input class="custom-switch permisssion-group-switch" type="checkbox" id="permisssion-group-switch-<?php echo e($groupName); ?>" />
                                            <label class="switch-label permisssion-group-switch" for="permisssion-group-switch-<?php echo e($groupName); ?>"></label>
                                        </div>
                                    </h5>
                                </div>
                                <div class="row g-4">
                                    <?php $__currentLoopData = $permission_value; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-lg-3 col-md-4 col-sm-6">
                                            <div class="form-group d-flex justify-content-start gap-3 mt-2 p-0">
                                                <div class="vendor-coupon-switch mt-2">
                                                    <input <?php if(in_array($permission->id,$rolePermissions)): ?> checked <?php endif; ?>
                                                    class="permission-switch custom-switch permisssion-switch-<?php echo e($permission->id); ?>"
                                                           type="checkbox"
                                                           id="permisssion-switch-<?php echo e($permission->id); ?>"
                                                           name="permission[]"
                                                           value="<?php echo e($permission->id); ?>"/>
                                                    <label class="switch-label permisssion-switch-<?php echo e($permission->id); ?>" for="permisssion-switch-<?php echo e($permission->id); ?>"></label>
                                                </div>
                                                <label class="m-0" for="permisssion-switch-<?php echo e($permission->id); ?>">
                                                    <strong><?php echo e(ucfirst(str_replace(['-','.'],[' ',' '],$permission->name))); ?></strong>
                                                </label>
                                            </div>
                                        </div>
                    ...
                    <div class="btn-wrapper mt-4">
                        <button type="submit" class="cmnBtn btn_5 btn_bg_blue radius-5"><?php echo e(__("Submit Now")); ?></button>
                    </div>
                </form>
            </div>
          </div>
...
<?php echo $__env->make('backend.admin-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\Modules/RolePermission\resources/views/roles/permissions.blade.php ENDPATH**/ ?>