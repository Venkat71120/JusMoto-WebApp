...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.notice.general-notice','data' => ['description' => __('Notice: The admin has the ability to create requests for the client if desired.'),'description1' => __('Notice: Admin can search by ticket id, request status, ticket priority.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: The admin has the ability to create requests for the client if desired.')),'description1' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: Admin can search by ticket id, request status, ticket priority.'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
