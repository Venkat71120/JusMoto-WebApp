                            ...
                            <div class="plugin-card">
                                ...
                                <div class="btn-group-wrap">
                                    <?php if($plugin->external): ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('plugins-status-change')): ?>
                                        ...
                                        <?php endif; ?>
                                      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('plugins-delete')): ?>
...
<?php echo $__env->make('backend.admin-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\Modules/PluginManage\Resources/views/plugin-manage/index.blade.php ENDPATH**/ ?>