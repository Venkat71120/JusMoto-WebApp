            ...
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="header-wrap d-flex justify-content-between mb-4">
                    <div class="left-content">
                        <h4 class="header-title"><?php echo e(__('Add New Product')); ?>   </h4>
                    </div>
                        ...
                        <div class="add-listing-wrapper mt-4">
                            ...
                            <div class="nav nav-pills" id="add-listing-tab"
                                ...
                                aria-selected="true">
                                 ...
                                 <?php echo e(__('Product Car')); ?>

                             </a>
                            </div>
                            <form action="<?php echo e(route('admin.add.new.product')); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div  class="add-listing-content-wrapper mt-4">
                                    <div class="tab-content add-listing-content" id="add-listing-tabContent">
                                        ...
                                        <?php echo $__env->make('backend.pages.products.admin.product-general-info', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                        <!-- Service general Info end-->

                                        <!-- Service include start-->
                                       <?php echo $__env->make('backend.pages.products.admin.product-include', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                        <!-- Service include end-->

                                        <?php echo $__env->make('backend.pages.products.admin.select-product-car', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<?php endif; ?>
        ...
        (function ($) {
            ...
            $(document).ready(function () {
                ...
                $(document).on('keyup', '#title', function (e) {
                    ...
                    let url = "<?php echo e(url('/product/')); ?>/" + slug;
    ...
    $(document).ready(function () 
    {
        ...
        $('#addAllVariant').on('click', function () 
        {
            $.ajax({
                        method: 'post',
                        url: "<?php echo e(route('admin.carProduct.add')); ?>",
                        data: {
                            variant_id:'all',
                        },
                        success: function(res) 
    ...
    $('#filterBtn').on('click', function () {
        ...
        $.ajax({
            url: "<?php echo e(route('admin.carProduct.filter')); ?>",
            method: 'GET',
...
<?php echo $__env->make('backend.admin-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/products/admin/create-product.blade.php ENDPATH**/ ?>