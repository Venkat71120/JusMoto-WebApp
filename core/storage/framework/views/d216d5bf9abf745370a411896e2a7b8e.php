<?php
    ...
    <div class="session_edit_service_car">
        <?php $__currentLoopData = $all_cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($car->brand_id && $car->car_id): ?>
                <div class="card mt-2 mb-4 w-100 car-card <?php echo e($key >= 5 ? 'd-none' : ''); ?>" data-index="<?php echo e($key); ?>"  id="session_edit_service_car_card">
                    <div class="card-body">
                        <div class="row">
                            <!-- First Column -->
                            <div class="col-3">
   ...
   <div id="search_edit_service_car_result">
...
<?php endif; ?>
   ...
   <?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/services/admin/edit_session_data.blade.php ENDPATH**/ ?>