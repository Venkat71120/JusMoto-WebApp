...
<script>
    (function ($) {
        ...
        $(document).on('click','.media_upload_modal_submit_btn',function (e) {
            ...
            let isModalOpen=$('#isModalOpen').val();
            if(isModalOpen=='true')
            {
                $('#addModal').modal('show');
            }
...
<?php /**PATH /Users/venkatesharavamudhan/Claude/JusMoto/main-files/Admin Panel/extracted/gocar-v1.1.0/core/resources/views/components/media/js.blade.php ENDPATH**/ ?>