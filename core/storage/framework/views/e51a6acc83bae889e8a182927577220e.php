...
<?php endif; ?>
                <form action="<?php echo e(route('admin.page.new')); ?>" method="POST" enctype="multipart/form-data" id="blog_new_form">
                    ...
                    <div class="form__input__flex mt-3">
                        ...
                        <div class="form__input__single permalink_label">
                            <label class="text-dark"><?php echo e(__('Permalink * :')); ?>
                                ...
                                <span id="slug_edit" class="d-inline">
                                  ...
                                  <input type="text" name="slug" class="form__control radius-5 blog_slug mt-2">
                                  <button class="cmnBtn btn_5 btn_bg_info radius-5 slug_update_button mt-2"><?php echo e(__('Update')); ?></button>
                                </span>
                            </label>
                        </div>
                        ...
                        <div class="row mt-5">
                            <?php if (isset($component)) { $__componentOriginal1864b77141addda05ef329ba4029da11 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1864b77141addda05ef329ba4029da11 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-meta-data-create','data' => ['sidebarHeading' => 'Page Meta']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1864b77141addda05ef329ba4029da11)): ?>
<?php $attributes = $__attributesOriginal1864b77141addda05ef329ba4029da11; ?>
<?php unset($__attributesOriginal1864b77141addda05ef329ba4029da11); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal1864b77141addda05ef329ba4029da11)): ?>
<?php $component = $__componentOriginal1864b77141addda05ef329ba4029da11; ?>
<?php unset($__componentOriginal1864b77141addda05ef329ba4029da11); ?>
<?php endif; ?>
                        </div>
                    </div>
            </div>
        ...
        <div class="col-xl-6 col-lg-6">
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="form__input__flex">
                        <div class="card-body">
                            <div class="alert alert-info mt-3"><?php echo e(__('if you enable page builder, your  page will load only page builder content.')); ?></div>
                            <div class="form-group">
                                <label for="page_builder_status"><strong><?php echo e(__('Enable/Disable Page Builder')); ?></strong></label>
                                <label class="switch">
                                    <input type="checkbox" name="page_builder_status"
                                           <?php if(!empty(get_static_option('page_builder_status'))): ?> checked <?php endif; ?> >
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fields.status','data' => ['name' => 'status','title' => __('Status')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.btn.submit','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('backend.admin-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/page/new.blade.php ENDPATH**/ ?>