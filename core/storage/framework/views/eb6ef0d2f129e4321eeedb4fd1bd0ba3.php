<?php echo $__env->make('frontend.user.layout.partial.common_header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<header class="header asbolute-header">
    <nav class="navbar navbar-area navbar-expand-lg">
        <div class="custom-container container nav-container">
            <div class="logo-wrapper">
              <a href="index.html" class="navbar-brand">
    <img src="<?php echo e(asset('assets/uploads/media-uploader/grid/grid-white1770204222.webp')); ?>" alt="GoCarLogo">
</a>
...
<main>
    ...
    <?php echo $__env->make('frontend.user.layout.partial.common_footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/frontend/pages/index.blade.php ENDPATH**/ ?>