            ...
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="header-wrap d-flex justify-content-between">
                    ...
                    <div class="right-content">
                        <a class="cmnBtn btn_5 btn_bg_info radius-5" href="<?php echo e(route('admin.all.services')); ?>">
                            <i class="las la-arrow-left"></i>
                            <?php echo e(__('Back to All Services')); ?>
...
<?php endif; ?>
            ...
            <div class="dashboard__card bg__white padding-20 radius-10">
                    ...
                    <div class="dashboard__card__header__flex">
                        <div class="dashboard__card__header__left">
                            <h5 class="dashboard__card__header__title">
                                ...
                                <?php echo e(__('Service Variant Info')); ?>
                ...
                <div class="task_assignments__table custom_table mt-4">
                    <table>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $service->serviceCar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceCar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="table_row">
                                        ...
                                        <div class="table_customer">
                                            <div class="table_customer__flex">
                                                <div class="table_customer__contents">
                                                    <h6 class="table_customer__title"><?php echo e($serviceCar?->varient?->car?->name ?? 'N/A'); ?></h6>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="price-display">
                                            <span class="regular"><?php echo e(float_amount_with_currency_symbol($serviceCar?->price)); ?></span>
                                        </div>
                                    </td>
                                    <td>
                                        <?php if($serviceCar?->discount_price > 0): ?>
                                            <div class="price-display">
                                                <span class="discounted"><?php echo e(float_amount_with_currency_symbol($serviceCar?->discount_price)); ?></span>
                                                <?php
                                                    $discount_percent = round((($serviceCar->price - $serviceCar->discount_price) / $serviceCar->price) * 100);
                                                ?>
                                                <span class="status-badge active">-<?php echo e($discount_percent); ?>%</span>
                                            </div>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <span class="status-badge info"><?php echo e($serviceCar?->varient?->engineType?->name ?? 'N/A'); ?></span>
                                    </td>
                                    <td>
                                        <span class="status-badge warning"><?php echo e($serviceCar?->varient?->fualType?->name ?? 'N/A'); ?></span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-4">
                                        <div class="empty-state">
                                            ...
                                            <p><?php echo e(__('No variants found')); ?></p>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
    ...
    <?php if($service->includes && $service->includes->count() > 0): ?>
        <div class="row g-4 mt-1">
            <div class="col-lg-12">
                <div class="dashboard__card bg__white padding-20 radius-10">
                    <div class="dashboard__card__header">
                        <div class="dashboard__card__header__flex">
                            <div class="dashboard__card__header__left">
                                <h5 class="dashboard__card__header__title">
                                    ...
                                    <?php echo e(__('Included Services')); ?>

                                    <span class="status-badge active"><?php echo e($service->includes->count()); ?></span>
                                </h5>
                            </div>
                        </div>
                    </div>
    ...
    <!-- FAQs Section -->
    <?php if($service->faqs && $service->faqs->count() > 0): ?>
        <div class="row g-4 mt-1">
            <div class="col-lg-12">
                <div class="dashboard__card bg__white padding-20 radius-10">
                    <div class="dashboard__card__header">
                        <div class="dashboard__card__header__flex">
                            <div class="dashboard__card__header__left">
                                <h5 class="dashboard__card__header__title">
                                    ...
                                    <span class="status-badge warning"><?php echo e($service->faqs->count()); ?></span>
                                </h5>
                            </div>
                        </div>
                    </div>
    ...
    <?php if($service->serviceAdditional && $service->serviceAdditional->count() > 0): ?>
        <!-- Info Type -->
        <div class="row g-4 mt-1">
            <div class="col-lg-12">
                <div class="dashboard__card bg__white padding-20 radius-10">
                    ...
                    <div class="task_assignments__table custom_table mt-4">
                        <table>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $service->serviceAdditional->where('type', 'info'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="table_row">
                                        <td><?php echo e($loop->iteration); ?></td>
                                        <td>
                                            <div class="img-thumb-wrapper">
                ...
                <div class="dashboard__card bg__white padding-20 radius-10">
                    ...
                    <div class="task_assignments__table custom_table mt-4">
                        <table>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $service->serviceAdditional->where('type', 'specification'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="table_row">
                                        <td>#<?php echo e($spec->id); ?></td>
                                        <td>
                                            <div class="img-thumb-wrapper">
                                                <?php echo render_image_markup_by_attachment_id($spec->image, '', 'thumb'); ?>
                                        ...
                                        <td>
                                            <div class="table_customer">
                                                <div class="table_customer__flex">
                                                    <div class="table_customer__contents">
                                                        <h6 class="table_customer__title"><?php echo e($spec->title); ?></h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
