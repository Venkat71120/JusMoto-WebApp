            ...
            <div class="col-lg-12 col-md-12 mt-4">
             ...
             <div class="col-lg-12 col-md-12 mt-4">
                <div class="form__input__single position-relative">
                    ...
                    <div class="input-form input-form2">
                        <input type="text" class="form__control radius-5" name="duration" id="duration" value="<?php echo e(old('duration')); ?>" placeholder="<?php echo e(__('e.g.year,month,day')); ?>">
                    </div>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 mt-4">
...
<?php /**PATH C:\xampp\htdocs\JusMoto-WebApp\core\resources\views/backend/pages/products/admin/product-general-info.blade.php ENDPATH**/ ?>