...
?>
<style>
      .media_upload_modal_submit_btn{
        display: none;
      }
      .media_library_image_delete_btn{
        display: none;
      }
      .image_id{
        display: none;
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                            ...
                            <div class="main-content-area-wrap">
                                ...
                                <div class="media-uploader-image-info">
                                    ...
                                    <div class="img-info">
                                        ...
                                        <a tabindex="0" class=" btn btn-lg btn-danger btn-sm mb-3 mr-1 media_library_image_delete_btn" data-type="admin" role="button">
            ...
            <div class="modal-footer">
                <button type="button"
                class="red-btn cmnBtn btn_5 btn_bg_blue radius-5 media_upload_modal_submit_btn"><?php echo e(__('Set Image')); ?></button>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /Users/venkatesharavamudhan/Claude/JusMoto/main-files/Admin Panel/extracted/gocar-v1.1.0/core/resources/views/components/media/markup.blade.php ENDPATH**/ ?>